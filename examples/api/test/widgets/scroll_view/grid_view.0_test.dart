...
void main() {
  testWidgets('$CustomGridLayout', (WidgetTester tester) async {
    ...
    final List<double> scrollOffsets =
        List<double>.generate(10, (int i) => layout.computeMaxScrollOffset(i));
