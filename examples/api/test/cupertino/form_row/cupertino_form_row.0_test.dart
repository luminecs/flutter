...
import 'package:flutter_api_samples/cupertino/form_row/cupertino_form_row.0.dart'
    as example;
...
void main() {
  testWidgets('Cupertino form section displays cupertino form rows',
    ...
    expect(find.widgetWithText(CupertinoFormSection, 'Connectivity'),
        findsOneWidget);
    expect(
        find.widgetWithText(CupertinoFormRow, 'Airplane Mode'), findsOneWidget);
    ...
    expect(
        find.widgetWithText(CupertinoFormRow, 'Mobile Data'), findsOneWidget);
  });
}
