...
void main() {
  testWidgets('Can change date, time and dateTime using CupertinoDatePicker',
    ...
    await tester.drag(find.text('October'), _kRowOffset,
        touchSlopY: 0, warnIfMissed: false); // see top of file
    await tester.drag(find.textContaining('26').last, _kRowOffset,
        touchSlopY: 0, warnIfMissed: false); // see top of file
    await tester.drag(find.text('2016'), _kRowOffset,
        touchSlopY: 0, warnIfMissed: false); // see top of file
    ...
    await tester.drag(find.text('22'), const Offset(0.0, 50.0),
        touchSlopY: 0, warnIfMissed: false); // see top of file
    await tester.drag(find.text('35'), const Offset(0.0, 50.0),
        touchSlopY: 0, warnIfMissed: false); // see top of file
    ...
    // Drag hour and minute wheels to change the picked time.
    await tester.drag(find.text('17'), const Offset(0.0, 50.0),
        touchSlopY: 0, warnIfMissed: false); // see top of file
    await tester.drag(find.text('45'), const Offset(0.0, 50.0),
        touchSlopY: 0, warnIfMissed: false); // see top of file
