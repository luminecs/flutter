...
import 'package:flutter_api_samples/material/refresh_indicator/refresh_indicator.1.dart'
    as example;
...
void main() {
  testWidgets('Pulling from nested scroll view triggers refresh indicator',
    ...
    await tester.fling(
        find.text('Pull down here').first, const Offset(0.0, 300.0), 1000.0);
    await tester.pump();
    ...
    await tester.fling(
        find.text('Pull down here').at(3), const Offset(0.0, 300.0), 1000.0);
    await tester.pump();
