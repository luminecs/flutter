...
void main() {
  ...
  testGesture('Invalid pressure ranges capabilities are not recognized',
  ...
  testGesture(
    ...
    tester.route(pointer.move(const Offset(30.0,
        30.0))); // moved 20 horizontally and 20 vertically which is 28 total
  ...
  testGesture(
    ...
    final ForcePressGestureRecognizer force =
        ForcePressGestureRecognizer(interpolation: interpolateWithEasing);
  ...
  testGesture('A pressure of NAN will not give an error',
      (GestureTester tester) {
    // Device specific constants that represent those from the iPhone X
    const double pressureMin = 0;
    const double pressureMax = 6.66;
