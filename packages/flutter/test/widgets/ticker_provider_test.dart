...
void main() {
  ...
  testWidgetsWithLeakTracking('Navigation with TickerMode',
  ...
  group('TickerProviderStateMixin assertion control test', () {
    ...
    testWidgetsWithLeakTracking(
        ...
        (WidgetTester tester) async {
      final GlobalKey<_SingleTickerTestState> key =
          GlobalKey<_SingleTickerTestState>();
    ...
    testWidgetsWithLeakTracking(
        'TickerProviderStateMixin dispose while any ticker is active',
        (WidgetTester tester) async {
      final GlobalKey<_MultipleTickerTestState> key =
          GlobalKey<_MultipleTickerTestState>();
  ...
  testWidgetsWithLeakTracking(
    ...
    expect(
        tester
            .state<_SingleTickerTestState>(find.byType(_SingleTickerTest))
            .toStringCount,
        0);
  });
  ...
  testWidgetsWithLeakTracking(
    ...
    expect(
        tester
            .state<_MultipleTickerTestState>(find.byType(_MultipleTickerTest))
            .toStringCount,
        0);
  });
}
...
class _MultipleTickerTestState extends State<_MultipleTickerTest>
...
class _SingleTickerCreateMultipleTicker extends StatefulWidget {
  ...
  @override
  _SingleTickerCreateMultipleTickerState createState() =>
      _SingleTickerCreateMultipleTickerState();
}

class _SingleTickerCreateMultipleTickerState
    extends State<_SingleTickerCreateMultipleTicker>
    with SingleTickerProviderStateMixin {
  @override
  void initState() {
    super.initState();
