...
void main() {
  ...
  testWidgetsWithLeakTracking('Image for device pixel ratio 1.0',
  ...
  testWidgetsWithLeakTracking('Image for device pixel ratio 0.5',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Image for device pixel ratio 1.5',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Image for device pixel ratio 1.75',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Image for device pixel ratio 2.3',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Image for device pixel ratio 3.7',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Image for device pixel ratio 5.1',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Image cache resize upscale display 5',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Image cache resize upscale display 50',
      (WidgetTester tester) async {
    final Key key = GlobalKey();
    await pumpTreeToLayout(
  ...
  testWidgetsWithLeakTracking('Image cache resize downscale display 5',
      (WidgetTester tester) async {
    final Key key = GlobalKey();
    await pumpTreeToLayout(
  ...
  // available.
  testWidgetsWithLeakTracking('Low-resolution assets',
      (WidgetTester tester) async {
