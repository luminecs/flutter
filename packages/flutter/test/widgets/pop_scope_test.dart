...
void main() {
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
          ...
          routes: <String, WidgetBuilder>{
            '/': (BuildContext buildContext) => Scaffold(
                  body: StatefulBuilder(
                    builder:
                        (BuildContext buildContext, StateSetter stateSetter) {
      ...
      expect(
          ModalRoute.of(context)!.popDisposition, RoutePopDisposition.bubble);
    },
    variant: TargetPlatformVariant.all(),
  );

  testWidgetsWithLeakTracking(
    'toggling canPop on secondary route allows/prevents backs',
    (WidgetTester tester) async {
      ...
      expect(ModalRoute.of(homeContext)!.popDisposition,
      ...
      expect(
          ModalRoute.of(oneContext)!.popDisposition, RoutePopDisposition.pop);
      if (!kIsWeb && defaultTargetPlatform == TargetPlatform.android) {
      ...
      expect(find.text('PopScope Page'), findsOneWidget);
      expect(find.text('Home Page'), findsNothing);
      expect(ModalRoute.of(oneContext)!.popDisposition,
