...
Future<void> pumpApp(WidgetTester tester,
    {GenerateAppTitle? onGenerateTitle, Color? color}) async {
...
void main() {
  ...
  testWidgetsWithLeakTracking('Specified color is made opaque for Title',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('onGenerateTitle handles changing locales',
      (WidgetTester tester) async {
