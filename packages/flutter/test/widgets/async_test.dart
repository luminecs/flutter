...
void main() {
  ...
  group('AsyncSnapshot', () {
    ...
    test('AsyncSnapshot basic constructors', () {
      expect(const AsyncSnapshot<int>.nothing().connectionState,
      ...
      expect(const AsyncSnapshot<int>.waiting().connectionState,
  ...
  group('FutureBuilder', () {
    testWidgetsWithLeakTracking(
      ...
      final SynchronousFuture<String> future =
          SynchronousFuture<String>('flutter');
      await tester.pumpWidget(FutureBuilder<String>(
        future: future,
    ...
    testWidgetsWithLeakTracking('gracefully handles transition to null future',
        (WidgetTester tester) async {
      final GlobalKey key = GlobalKey();
      final Completer<String> completer = Completer<String>();
      await tester.pumpWidget(FutureBuilder<String>(
    ...
    testWidgetsWithLeakTracking('gracefully handles transition to other future',
        (WidgetTester tester) async {
      final GlobalKey key = GlobalKey();
      ...
      expect(
          find.text(
              'AsyncSnapshot<String>(ConnectionState.done, B, null, null)'),
          findsOneWidget);
    });
    testWidgetsWithLeakTracking('tracks life-cycle of Future to success',
        (WidgetTester tester) async {
      final Completer<String> completer = Completer<String>();
      await tester.pumpWidget(FutureBuilder<String>(
        future: completer.future,
    ...
    testWidgetsWithLeakTracking('tracks life-cycle of Future to error',
        (WidgetTester tester) async {
      final Completer<String> completer = Completer<String>();
      await tester.pumpWidget(FutureBuilder<String>(
        future: completer.future,
      ...
      expect(
          find.text(
              'AsyncSnapshot<String>(ConnectionState.done, null, bad, trace)'),
          findsOneWidget);
    });
    testWidgetsWithLeakTracking('runs the builder using given initial data',
        (WidgetTester tester) async {
      final GlobalKey key = GlobalKey();
      await tester.pumpWidget(FutureBuilder<String>(
        key: key,
      ...
      expect(
          find.text(
              'AsyncSnapshot<String>(ConnectionState.none, I, null, null)'),
          findsOneWidget);
    });
    testWidgetsWithLeakTracking('ignores initialData when reconfiguring',
        (WidgetTester tester) async {
      final GlobalKey key = GlobalKey();
      await tester.pumpWidget(FutureBuilder<String>(
        key: key,
    ...
    testWidgetsWithLeakTracking('debugRethrowError rethrows caught error',
        (WidgetTester tester) async {
  ...
  group('StreamBuilder', () {
    ...
    testWidgetsWithLeakTracking('gracefully handles transition to null stream',
        (WidgetTester tester) async {
      final GlobalKey key = GlobalKey();
      final StreamController<String> controller = StreamController<String>();
      await tester.pumpWidget(StreamBuilder<String>(
    ...
    testWidgetsWithLeakTracking('gracefully handles transition to other stream',
        (WidgetTester tester) async {
      final GlobalKey key = GlobalKey();
    ...
    testWidgetsWithLeakTracking(
      ...
      expect(
          find.text(
              'AsyncSnapshot<String>(ConnectionState.done, 4, null, null)'),
          findsOneWidget);
    });
    testWidgetsWithLeakTracking('runs the builder using given initial data',
        (WidgetTester tester) async {
  ...
  group(
      ...
      () {
    testWidgetsWithLeakTracking('when completing with data',
        (WidgetTester tester) async {
      final Completer<String> completer = Completer<String>();
    ...
    testWidgetsWithLeakTracking(
        'when completing with error and with stack trace',
        (WidgetTester tester) async {
      final Completer<String> completer = Completer<String>();
      await tester.pumpWidget(Column(children: <Widget>[
        FutureBuilder<String>(future: completer.future, builder: snapshotText),
    ...
    testWidgetsWithLeakTracking('when Future is null',
        (WidgetTester tester) async {
      await tester.pumpWidget(Column(children: <Widget>[
    ...
    testWidgetsWithLeakTracking(
      ...
      await tester.pumpWidget(Column(children: <Widget>[
        FutureBuilder<String>(
            builder: snapshotText, initialData: 'I', future: null),
        StreamBuilder<String>(
            builder: snapshotText, initialData: 'I', stream: null),
      ]));
      expect(
          find.text(
              'AsyncSnapshot<String>(ConnectionState.none, I, null, null)'),
  ...
  group('StreamBuilderBase', () {
    ...
    testWidgetsWithLeakTracking('tracks events and errors until completion',
        (WidgetTester tester) async {
      final GlobalKey key = GlobalKey();
      final StreamController<String> controller = StreamController<String>();
      await tester
      ...
      await eventFiring(tester);
      expect(
          find.text('conn, data:1, error:bad stackTrace:trace, data:2, done'),
          findsOneWidget);
    });
  });
}
