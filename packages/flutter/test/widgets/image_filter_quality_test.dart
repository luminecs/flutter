...
void main() {
  testWidgetsWithLeakTracking('Image at default filterQuality',
      (WidgetTester tester) async {
    await testImageQuality(tester, null);
  });

  testWidgetsWithLeakTracking('Image at high filterQuality',
      (WidgetTester tester) async {
    await testImageQuality(tester, ui.FilterQuality.high);
  });

  testWidgetsWithLeakTracking('Image at none filterQuality',
      (WidgetTester tester) async {
