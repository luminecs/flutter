...
void main() {
  test('IconThemeData control test', () {
    const IconThemeData data = IconThemeData(
      ...
      shadows: <Shadow>[
        Shadow(
            color: Color(0xAAAAAAAA), blurRadius: 1.0, offset: Offset(1.0, 1.0))
      ],
    );
    ...
    final IconThemeData lerped =
        IconThemeData.lerp(data, const IconThemeData.fallback(), 0.25);
  ...
  group('IconThemeData lerp', () {
    const IconThemeData data = IconThemeData(
      ...
      shadows: <Shadow>[
        Shadow(
            color: Color(0xFFFFFFFF), blurRadius: 1.0, offset: Offset(1.0, 1.0))
      ],
    );
