...
void main() {
  ...
  group('SelectableRegion', () {
    testWidgetsWithLeakTracking(
        'mouse selection single click sends correct events',
      ...
      expect(renderSelectionSpy.events[0].type,
      ...
      expect(
          renderSelectionSpy.events[1].type, SelectionEventType.endEdgeUpdate);
      SelectionEdgeUpdateEvent endEdge =
          renderSelectionSpy.events[1] as SelectionEdgeUpdateEvent;
      ...
      expect(
          renderSelectionSpy.events[0].type, SelectionEventType.endEdgeUpdate);
    ...
    testWidgetsWithLeakTracking('mouse double click sends select-word event',
        (WidgetTester tester) async {
      final UniqueKey spy = UniqueKey();
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgetsWithLeakTracking('Does not crash when using Navigator pages',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking(
            ...
            children: <Widget>[
              ...
              SelectableRegion(
                ...
                child: SelectAllWidget(
                    key: spy, child: const SizedBox(width: 100, height: 100)),
              ),
              const Text('Fine, thank you.'),
            ],
          ),
      ...
      final TestGesture gesture =
          await tester.startGesture(tester.getCenter(find.byKey(spy)));
      addTearDown(gesture.removePointer);
      await tester.pump(const Duration(milliseconds: 500));
      await gesture.up();
      await tester.pump();

      final RenderSelectAll renderSpy =
          tester.renderObject<RenderSelectAll>(find.byKey(spy));
      expect(renderSpy.startHandle, isNotNull);
      expect(renderSpy.endHandle, isNotNull);
    });

    testWidgetsWithLeakTracking('touch does not accept drag',
        (WidgetTester tester) async {
      final UniqueKey spy = UniqueKey();
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      expect(
          renderSelectionSpy.events.every(
              (SelectionEvent element) => element is ClearSelectionEvent),
          isTrue);
    });

    testWidgetsWithLeakTracking('does not merge semantics node of the children',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('touch long press sends select-word event',
        (WidgetTester tester) async {
      final UniqueKey spy = UniqueKey();
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgetsWithLeakTracking(
        'touch long press and drag sends correct events',
        (WidgetTester tester) async {
      final UniqueKey spy = UniqueKey();
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgetsWithLeakTracking(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          renderSelectionSpy.events
              .any((SelectionEvent element) => element is ClearSelectionEvent),
          isFalse,
        );
      },
    );
    ...
    testWidgetsWithLeakTracking(
      ...
      (WidgetTester tester) async {
        ...
        final RenderSelectionSpy renderSelectionSpy =
            tester.renderObject<RenderSelectionSpy>(find.byKey(spy));
        renderSelectionSpy.events.clear();
        final TestGesture selectGesture =
            await tester.startGesture(const Offset(200.0, 200.0));
    ...
    testWidgetsWithLeakTracking(
        'mouse long press does not send select-word event',
        (WidgetTester tester) async {
      final UniqueKey spy = UniqueKey();
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      expect(
        renderSelectionSpy.events
            .every((SelectionEvent element) => element is ClearSelectionEvent),
        isTrue,
      );
    });
  });
  ...
  testWidgetsWithLeakTracking(
    ...
    final RenderParagraph paragraph = tester.renderObject<RenderParagraph>(
        find.descendant(
            of: find.text('How are you?'), matching: find.byType(RichText)));
    final TestGesture gesture = await tester
        .startGesture(textOffsetToPosition(paragraph, 6)); // at the 'r'
    addTearDown(gesture.removePointer);
    await tester.pump(const Duration(milliseconds: 500));
    await gesture.up();
    await tester.pump(const Duration(milliseconds: 500));
    ...
    final List<TextBox> boxes =
        paragraph.getBoxesForSelection(paragraph.selections[0]);
    expect(boxes.length, 1);
    final Offset handlePos =
        globalize(boxes[0].toRect().bottomRight, paragraph);
    await gesture.down(handlePos);
    final Offset endPos =
        Offset(textOffsetToPosition(paragraph, 8).dx, handlePos.dy);
  ...
  group('SelectionArea integration', () {
    testWidgetsWithLeakTracking('mouse can select single text',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      await gesture.moveTo(
          textOffsetToPosition(paragraph, 5) + const Offset(0.0, 200.0));
      await tester.pump();
      expect(paragraph.selections[0],
          const TextSelection(baseOffset: 5, extentOffset: 11));

      await gesture.up();
    });

    testWidgetsWithLeakTracking(
        'mouse can select word-by-word on double click drag',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgetsWithLeakTracking(
        'mouse can select multiple widgets on double click drag',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      await tester.pumpAndSettle();
      expect(paragraph1.selections[0],
          const TextSelection(baseOffset: 0, extentOffset: 3));
      ...
      expect(paragraph3.selections[0],
          const TextSelection(baseOffset: 0, extentOffset: 11));
    ...
    testWidgetsWithLeakTracking(
        'mouse can reverse selection across multiple widgets on double click drag',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      expect(paragraph3.selections[0],
          const TextSelection(baseOffset: 11, extentOffset: 0));
      expect(paragraph2.selections[0],
          const TextSelection(baseOffset: 14, extentOffset: 0));
      expect(paragraph1.selections[0],
          const TextSelection(baseOffset: 12, extentOffset: 4));

      await gesture.up();
    }, skip: kIsWeb); // https://github.com/flutter/flutter/issues/125582.

    testWidgetsWithLeakTracking('mouse can select multiple widgets',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgetsWithLeakTracking('mouse can work with disabled container',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgetsWithLeakTracking('mouse can reverse selection',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      expect(paragraph2.selections[0],
          const TextSelection(baseOffset: 14, extentOffset: 0));
      expect(paragraph1.selections[0],
          const TextSelection(baseOffset: 12, extentOffset: 6));
      ...
      (WidgetTester tester) async {
        ...
        final RenderParagraph paragraph = tester.renderObject<RenderParagraph>(
            find.descendant(
                ...
                matching: find.byType(RichText)));
        final TestGesture gesture =
            await tester.startGesture(textOffsetToPosition(paragraph, 2));
        addTearDown(gesture.removePointer);
        await tester.pump(const Duration(milliseconds: 500));
        await gesture.up();
        await tester.pumpAndSettle();
    ...
    testWidgetsWithLeakTracking('can copy a selection made with the mouse',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgetsWithLeakTracking(
      ...
      (WidgetTester tester) async {
        final TextEditingController controller =
            TextEditingController(text: 'I am fine, thank you.');
              ...
              child: SelectableRegion(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextField(
                        controller: controller, focusNode: textFieldFocus),
                  ],
                ),
              ),
            ),
    ...
    testWidgetsWithLeakTracking(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pump();
        await gesture
            .moveTo(textOffsetToPosition(paragraph, 17)); // right after `Fine`.
        await gesture.up();
    ...
    testWidgetsWithLeakTracking(
      ...
      (WidgetTester tester) async {
        ...
        final Offset gestureOffset =
            textOffsetToPosition(paragraph, 125).translate(0, 10);

        // Right click to select word at position.
        final TestGesture gesture = await tester.startGesture(gestureOffset,
    ...
    testWidgetsWithLeakTracking('mouse can select across bidi text',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      final RenderParagraph paragraph2 = tester.renderObject<RenderParagraph>(
          find.descendant(
              of: find.text('جيد وانت؟'), matching: find.byType(RichText)));
      await gesture.moveTo(textOffsetToPosition(paragraph2, 5));
      // Should select the rest of paragraph 1.
      expect(paragraph1.selections[0],
          const TextSelection(baseOffset: 2, extentOffset: 12));
      ...
      await gesture
          .moveTo(textOffsetToPosition(paragraph3, 6) + const Offset(0, 1));
      expect(paragraph1.selections[0],
          const TextSelection(baseOffset: 2, extentOffset: 12));
      expect(paragraph2.selections[0],
    ...
    testWidgetsWithLeakTracking(
        'long press and drag touch moves selection word by word',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      final RenderParagraph paragraph1 = tester.renderObject<RenderParagraph>(
          find.descendant(
              of: find.text('How are you?'), matching: find.byType(RichText)));
      final TestGesture gesture = await tester
          .startGesture(textOffsetToPosition(paragraph1, 6)); // at the 'r'
      addTearDown(gesture.removePointer);
      await tester.pump(const Duration(milliseconds: 500));
      // `are` is selected.
      expect(paragraph1.selections[0],
    ...
    testWidgetsWithLeakTracking(
        'can drag end handle when not covering entire screen',
        (WidgetTester tester) async {
      ...
      final RenderParagraph paragraph2 = tester.renderObject<RenderParagraph>(
          find.descendant(
              ...
              matching: find.byType(RichText)));
      final TestGesture gesture = await tester
          .startGesture(textOffsetToPosition(paragraph2, 7)); // at the 'a'
      addTearDown(gesture.removePointer);
      await tester.pump(const Duration(milliseconds: 500));
      await gesture.up();
      await tester.pump(const Duration(milliseconds: 500));
      ...
      final List<TextBox> boxes =
          paragraph2.getBoxesForSelection(paragraph2.selections[0]);
      expect(boxes.length, 1);

      final Offset handlePos =
          globalize(boxes[0].toRect().bottomRight, paragraph2);
      await gesture.down(handlePos);

      await gesture.moveTo(textOffsetToPosition(paragraph2, 11) +
          Offset(0, paragraph2.size.height / 2));
      expect(paragraph2.selections[0],
          const TextSelection(baseOffset: 6, extentOffset: 11));
      await gesture.up();
    });
    ...
    testWidgetsWithLeakTracking(
        'can drag start handle when not covering entire screen',
        (WidgetTester tester) async {
      // Regression test for https://github.com/flutter/flutter/issues/104620.
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      final Offset handlePos =
          globalize(boxes[0].toRect().bottomLeft, paragraph2);
      await gesture.down(handlePos);

      await gesture.moveTo(textOffsetToPosition(paragraph2, 11) +
          Offset(0, paragraph2.size.height / 2));
      expect(paragraph2.selections[0],
          const TextSelection(baseOffset: 11, extentOffset: 9));
      await gesture.up();
    });

    testWidgetsWithLeakTracking('can drag start selection handle',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      final RenderParagraph paragraph3 = tester.renderObject<RenderParagraph>(
          find.descendant(
              ...
              matching: find.byType(RichText)));
      final TestGesture gesture = await tester
          .startGesture(textOffsetToPosition(paragraph3, 7)); // at the 'h'
      addTearDown(gesture.removePointer);
      await tester.pump(const Duration(milliseconds: 500));
      await gesture.up();
      await tester.pump(const Duration(milliseconds: 500));
      expect(paragraph3.selections[0],
          const TextSelection(baseOffset: 6, extentOffset: 11));
      final List<TextBox> boxes =
          paragraph3.getBoxesForSelection(paragraph3.selections[0]);
      expect(boxes.length, 1);

      final Offset handlePos =
          globalize(boxes[0].toRect().bottomLeft, paragraph3);
      await gesture.down(handlePos);
      final RenderParagraph paragraph2 = tester.renderObject<RenderParagraph>(
          find.descendant(
              of: find.text('Good, and you?'),
      ...
      final RenderParagraph paragraph1 = tester.renderObject<RenderParagraph>(
          find.descendant(
              of: find.text('How are you?'), matching: find.byType(RichText)));
      await gesture.moveTo(textOffsetToPosition(paragraph1, 6) +
          Offset(0, paragraph1.size.height / 2));
      expect(paragraph3.selections[0],
          const TextSelection(baseOffset: 0, extentOffset: 11));
      expect(paragraph2.selections[0],
          const TextSelection(baseOffset: 0, extentOffset: 14));
    ...
    testWidgetsWithLeakTracking(
        'can drag start selection handle across end selection handle',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      final Offset handlePos =
          globalize(boxes[0].toRect().bottomLeft, paragraph3);
      await gesture.down(handlePos);
      await gesture.moveTo(textOffsetToPosition(paragraph3, 14) +
          Offset(0, paragraph3.size.height / 2));
      expect(paragraph3.selections[0],
          const TextSelection(baseOffset: 14, extentOffset: 11));
    ...
    testWidgetsWithLeakTracking(
        'can drag end selection handle across start selection handle',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      final Offset handlePos =
          globalize(boxes[0].toRect().bottomRight, paragraph3);
      await gesture.down(handlePos);
      await gesture.moveTo(textOffsetToPosition(paragraph3, 4) +
          Offset(0, paragraph3.size.height / 2));
      expect(paragraph3.selections[0],
          const TextSelection(baseOffset: 6, extentOffset: 4));

      await gesture.moveTo(textOffsetToPosition(paragraph3, 12) +
          Offset(0, paragraph3.size.height / 2));
      expect(paragraph3.selections[0],
          const TextSelection(baseOffset: 6, extentOffset: 12));
      await gesture.up();
    ...
    testWidgetsWithLeakTracking('can select all from toolbar',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgetsWithLeakTracking('can copy from toolbar',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgetsWithLeakTracking(
        'can use keyboard to granularly extend selection - word',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      await sendKeyCombination(
          ...
          SingleActivator(LogicalKeyboardKey.arrowRight,
              shift: true, alt: alt, control: control));
      await tester.pump();
      // Ho[w are] you?
      // Good, and you?
      // Fine, thank you.
    ...
    testWidgetsWithLeakTracking(
        'can use keyboard to granularly extend selection - line',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgetsWithLeakTracking(
        'can use keyboard to directionally extend selection',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    (WidgetTester tester) async {
      ...
      final RenderParagraph paragraph1 = tester.renderObject<RenderParagraph>(
          find.descendant(
              of: find.text('How are you?'), matching: find.byType(RichText)));
      await tester
          .longPressAt(textOffsetToPosition(paragraph1, 6)); // at the 'r'
  ...
  testWidgetsWithLeakTracking(
      'onSelectionChange is called when the selection changes through gestures',
      (WidgetTester tester) async {
    ...
    final Offset startHandlePos =
        globalize(boxes[0].toRect().bottomLeft, paragraph);
    final Offset endHandlePos =
        globalize(boxes[0].toRect().bottomRight, paragraph);
    final Offset startPos =
        Offset(textOffsetToPosition(paragraph, 4).dx, startHandlePos.dy);
    final Offset endPos =
        Offset(textOffsetToPosition(paragraph, 6).dx, endHandlePos.dy);
  ...
  testWidgetsWithLeakTracking(
      'onSelectionChange is called when the selection changes through keyboard actions',
      (WidgetTester tester) async {
    SelectedContent? content;
    final FocusNode focusNode = FocusNode();
    addTearDown(focusNode.dispose);
    ...
    final RenderParagraph paragraph2 = tester.renderObject<RenderParagraph>(
        find.descendant(
            of: find.text('Good, and you?'), matching: find.byType(RichText)));
    final RenderParagraph paragraph3 = tester.renderObject<RenderParagraph>(
        find.descendant(
            of: find.text('Fine, thank you.'),
            matching: find.byType(RichText)));
    ...
    await sendKeyCombination(
        tester, const SingleActivator(LogicalKeyboardKey.arrowUp, shift: true));
    await tester.pump();
    expect(paragraph1.selections.length, 1);
    expect(paragraph1.selections[0].start, 2);
    expect(paragraph1.selections[0].end, 12);
  ...
  testWidgetsWithLeakTracking(
      'Multiple selectables on a single line should be in screen order',
      (WidgetTester tester) async {
    ...
    final RenderParagraph paragraph1 = tester.renderObject<RenderParagraph>(find
        .descendant(of: find.byKey(outerText), matching: find.byType(RichText))
        .first);
    final TestGesture gesture = await tester.startGesture(
    ...
    // Select all.
    await sendKeyCombination(
        tester, const SingleActivator(LogicalKeyboardKey.keyA, control: true));

    // keyboard copy.
    await sendKeyCombination(
        tester, const SingleActivator(LogicalKeyboardKey.keyC, control: true));
