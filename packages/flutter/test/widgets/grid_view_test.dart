...
void main() {
  ...
  testWidgetsWithLeakTracking(
      'GridView.builder respects findChildIndexCallback',
  ...
  testWidgetsWithLeakTracking('GridView.count control test',
      (WidgetTester tester) async {
    ...
    expect(tester.getSize(find.text('Arkansas')),
        equals(const Size(200.0, 200.0)));
  ...
  testWidgetsWithLeakTracking('GridView.extent control test',
      (WidgetTester tester) async {
    final List<String> log = <String>[];
  ...
  testWidgetsWithLeakTracking('GridView large scroll jump',
      (WidgetTester tester) async {
    ...
    expect(tester.getSize(find.text('4')),
        equals(const Size(200.0 / 0.75, 200.0)));
  ...
  testWidgetsWithLeakTracking('GridView - change crossAxisCount',
      (WidgetTester tester) async {
    final List<int> log = <int>[];
  ...
  testWidgetsWithLeakTracking('GridView - change maxChildCrossAxisExtent',
      (WidgetTester tester) async {
    final List<int> log = <int>[];
  ...
  testWidgetsWithLeakTracking('One-line GridView paints',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('GridView in zero context',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('GridView in unbounded context',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('GridView.builder control test',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('GridView.builder with undefined itemCount',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('GridView cross axis layout',
      (WidgetTester tester) async {
    ...
    expect(
        tester.getBottomRight(find.byKey(target)), const Offset(200.0, 200.0));

    await tester.pumpWidget(build(TextDirection.rtl));

    expect(tester.getTopLeft(find.byKey(target)), const Offset(600.0, 0.0));
    expect(
        tester.getBottomRight(find.byKey(target)), const Offset(800.0, 200.0));
  });

  testWidgetsWithLeakTracking('GridView crossAxisSpacing',
      (WidgetTester tester) async {
    ...
    expect(tester.getTopLeft(find.byKey(target)), Offset.zero);
    expect(
        tester.getBottomRight(find.byKey(target)), const Offset(194.0, 194.0));

    await tester.pumpWidget(build(TextDirection.rtl));

    expect(tester.getTopLeft(find.byKey(target)), const Offset(606.0, 0.0));
    expect(
        tester.getBottomRight(find.byKey(target)), const Offset(800.0, 194.0));
  });

  testWidgetsWithLeakTracking('GridView does not cache itemBuilder calls',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('GridView respects clipBehavior',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('GridView.builder respects clipBehavior',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('GridView.custom respects clipBehavior',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('GridView.count respects clipBehavior',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('GridView.extent respects clipBehavior',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking(
      'SliverGridDelegateWithFixedCrossAxisCount mainAxisExtent works as expected',
      (WidgetTester tester) async {
    ...
    expect(tester.getSize(find.text('4')),
        equals(const Size(200.0, mainAxisExtent)));
  });

  testWidgetsWithLeakTracking(
      'SliverGridDelegateWithMaxCrossAxisExtent mainAxisExtent works as expected',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'SliverGrid sets correct extent for null returning builder delegate',
      (WidgetTester tester) async {
    ...
    await tester.fling(
        find.byType(GridView), const Offset(0.0, -1300.0), 100.0);
    await tester.pumpAndSettle();
