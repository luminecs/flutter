...
void main() {
  group(ActionDispatcher, () {
    testWidgetsWithLeakTracking('ActionDispatcher invokes actions when asked.',
  ...
  group(Actions, () {
    ...
    testWidgetsWithLeakTracking(
        'Actions widget can invoke actions with default dispatcher',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('invoke throws when no action is found',
        (WidgetTester tester) async {
      final GlobalKey containerKey = GlobalKey();
      bool invoked = false;
    ...
    testWidgetsWithLeakTracking('Actions widget can be found with of',
        (WidgetTester tester) async {
      final GlobalKey containerKey = GlobalKey();
    ...
    testWidgetsWithLeakTracking('Action can be found with find',
        (WidgetTester tester) async {
      final GlobalKey containerKey = GlobalKey();
      final ActionDispatcher testDispatcher =
          TestDispatcher1(postInvoke: collect);
    ...
    testWidgetsWithLeakTracking('ContextAction can return null',
        (WidgetTester tester) async {
      final GlobalKey containerKey = GlobalKey();
      const TestIntent intent = TestIntent();
  ...
  group('Listening', () {
    testWidgetsWithLeakTracking('can listen to enabled state of Actions',
        (WidgetTester tester) async {
      final GlobalKey containerKey = GlobalKey();
      bool invoked1 = false;
      bool invoked2 = false;
  ...
  group('Action subclasses', () {
    ...
    testWidgetsWithLeakTracking('VoidCallbackAction',
        (WidgetTester tester) async {
      bool called = false;
      void testCallback() {
        called = true;
  ...
  group('Diagnostics', () {
    testWidgetsWithLeakTracking('default Intent debugFillProperties',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('default Actions debugFillProperties',
        (WidgetTester tester) async {
      final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
    ...
    testWidgetsWithLeakTracking('Actions implements debugFillProperties',
        (WidgetTester tester) async {
      final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
  ...
  group('Action overriding', () {
    ...
    testWidgetsWithLeakTracking('Does not break after use',
        (WidgetTester tester) async {
      late BuildContext invokingContext2;
      late BuildContext invokingContext3;
      await tester.pumpWidget(
    ...
    testWidgetsWithLeakTracking('Does not override if not overridable',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        Builder(
          builder: (BuildContext context1) {
    ...
    testWidgetsWithLeakTracking('The final override controls isEnabled',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        Builder(
          builder: (BuildContext context1) {
    ...
    testWidgetsWithLeakTracking('Throws on infinite recursions',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('Throws on invoking invalid override',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        Builder(
    ...
    testWidgetsWithLeakTracking('Make an overridable action overridable',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        Builder(
          builder: (BuildContext context1) {
    ...
    testWidgetsWithLeakTracking('Overriding Actions can change the intent',
        (WidgetTester tester) async {
