...
void main() {
  testWidgetsWithLeakTracking('WidgetsApp control test',
  ...
  testWidgetsWithLeakTracking('showPerformanceOverlayOverride true',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('showPerformanceOverlayOverride false',
      (WidgetTester tester) async {
    WidgetsApp.showPerformanceOverlayOverride = true;
  ...
  testWidgetsWithLeakTracking('debugAllowBannerOverride false',
      (WidgetTester tester) async {
    expect(WidgetsApp.showPerformanceOverlayOverride, false);
  ...
  testWidgetsWithLeakTracking('debugAllowBannerOverride true',
      (WidgetTester tester) async {
    WidgetsApp.debugAllowBannerOverride = false;
    expect(WidgetsApp.showPerformanceOverlayOverride, false);
