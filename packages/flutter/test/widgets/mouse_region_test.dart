...
void main() {
  ...
  testWidgetsWithLeakTracking('detects pointer enter',
      (WidgetTester tester) async {
    PointerEnterEvent? enter;
  ...
  testWidgetsWithLeakTracking('detects pointer exiting',
      (WidgetTester tester) async {
    PointerEnterEvent? enter;
    PointerHoverEvent? move;
    PointerExitEvent? exit;
  ...
  testWidgetsWithLeakTracking('triggers pointer enter when widget appears',
      (WidgetTester tester) async {
    PointerEnterEvent? enter;
    PointerHoverEvent? move;
    PointerExitEvent? exit;
  ...
  testWidgetsWithLeakTracking('triggers pointer enter when widget moves in',
      (WidgetTester tester) async {
    PointerEnterEvent? enter;
    PointerHoverEvent? move;
    PointerExitEvent? exit;
  ...
  testWidgetsWithLeakTracking('triggers pointer exit when widget moves out',
      (WidgetTester tester) async {
    PointerEnterEvent? enter;
    PointerHoverEvent? move;
    PointerExitEvent? exit;
  ...
  testWidgetsWithLeakTracking('detects hover from touch devices',
      (WidgetTester tester) async {
    PointerEnterEvent? enter;
    PointerHoverEvent? move;
    PointerExitEvent? exit;
  ...
  testWidgetsWithLeakTracking('Hover works with nested listeners',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Hover transfers between two listeners',
      (WidgetTester tester) async {
    final UniqueKey key1 = UniqueKey();
    final UniqueKey key2 = UniqueKey();
    final List<PointerEnterEvent> enter1 = <PointerEnterEvent>[];
  ...
  testWidgetsWithLeakTracking('applies mouse cursor',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('MouseRegion uses updated callbacks',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
    ...
    RenderMouseRegion listener =
        tester.renderObject(find.byType(MouseRegion).first);
  ...
  testWidgetsWithLeakTracking('works with transform',
      (WidgetTester tester) async {
    ...
    expect(
        events.single.delta, const Offset(0.0, scaleFactor * localHeight - 2));
    events.clear();
  ...
  testWidgetsWithLeakTracking('needsCompositing is always false',
      (WidgetTester tester) async {
    ...
    final RenderMouseRegion mouseRegion =
        tester.renderObject(find.byType(MouseRegion));
  ...
  testWidgetsWithLeakTracking("Callbacks aren't called during build",
      (WidgetTester tester) async {
    final TestGesture gesture =
        await tester.createGesture(kind: PointerDeviceKind.mouse);
    await gesture.addPointer(location: Offset.zero);
  ...
  testWidgetsWithLeakTracking(
      "MouseRegion activate/deactivate don't duplicate annotations",
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('detects pointer enter with closure arguments',
      (WidgetTester tester) async {
    ...
    await gesture.moveTo(tester.getBottomRight(find.byType(MouseRegion)) +
        const Offset(10, -10));
    await tester.pumpAndSettle();
    expect(find.text('not hovering'), findsOneWidget);
  ...
  testWidgetsWithLeakTracking(
      'MouseRegion paints child once and only once when MouseRegion is inactive',
      (WidgetTester tester) async {
    int paintCount = 0;
    await tester.pumpWidget(
      Directionality(
        ...
        child: MouseRegion(
          ...
          child: CustomPaint(
            painter: _DelegatedPainter(onPaint: () {
              paintCount += 1;
            }),
  ...
  testWidgetsWithLeakTracking(
      'MouseRegion paints child once and only once when MouseRegion is active',
      (WidgetTester tester) async {
    int paintCount = 0;
  ...
  testWidgetsWithLeakTracking(
      'A MouseRegion mounted under the pointer should take effect in the next postframe',
      (WidgetTester tester) async {
    bool hovered = false;
  ...
  testWidgetsWithLeakTracking(
      'A MouseRegion unmounted under the pointer should not trigger state change',
      (WidgetTester tester) async {
    bool hovered = true;
  ...
  testWidgetsWithLeakTracking(
      'A MouseRegion moved into the mouse should take effect in the next postframe',
      (WidgetTester tester) async {
    bool hovered = false;
  ...
  group('MouseRegion respects opacity:', () {
    ...
    Widget tripleRegions(
        {bool? opaqueC, required void Function(String) addLog}) {
      ...
      Widget mouseRegionWithOptionalOpaque({
        ...
        if (opaque == null) {
          return MouseRegion(
              onEnter: onEnter, onHover: onHover, onExit: onExit, child: child);
        }
        return MouseRegion(
            onEnter: onEnter,
            onHover: onHover,
    ...
    testWidgetsWithLeakTracking(
        'a transparent one should allow MouseRegions behind it to receive pointers',
        (WidgetTester tester) async {
      final List<String> logs = <String>[];
      ...
      await tester.pumpAndSettle();
      expect(logs,
          <String>['enterA', 'enterB', 'enterC', 'hoverC', 'hoverB', 'hoverA']);
      logs.clear();
    ...
    testWidgetsWithLeakTracking(
        'an opaque one should prevent MouseRegions behind it receiving pointers',
        (WidgetTester tester) async {
      final List<String> logs = <String>[];
      await tester.pumpWidget(tripleRegions(
        opaqueC: true,
    ...
    testWidgetsWithLeakTracking('opaque should default to true',
        (WidgetTester tester) async {
      final List<String> logs = <String>[];
      await tester.pumpWidget(tripleRegions(
        addLog: (String log) => logs.add(log),
  ...
  testWidgetsWithLeakTracking('an empty opaque MouseRegion is effective',
      (WidgetTester tester) async {
    ...
    await tester.pumpWidget(_Scaffold(
      topLeft: SizedBox(
        ...
        child: MouseRegion(
          onHover: handleHover,
          child: CustomPaint(
              painter: _DelegatedPainter(onPaint: handlePaintChild)),
        ),
      ),
      background: MouseRegion(onEnter: (_) {
  ...
  testWidgetsWithLeakTracking(
      'Changing MouseRegion.cursor is effective and repaints',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Changing whether MouseRegion.cursor is null is effective and repaints',
      (WidgetTester tester) async {
    final List<String> logEnters = <String>[];
    final List<String> logPaints = <String>[];
      ...
      topLeft: SizedBox(
        ...
        child: MouseRegion(
          ...
          child: MouseRegion(
            ...
            child:
                CustomPaint(painter: _DelegatedPainter(onPaint: onPaintChild)),
          ),
        ),
      ),
    ));
  ...
  testWidgetsWithLeakTracking('Does not trigger side effects during a reparent',
      (WidgetTester tester) async {
    final List<String> logEnters = <String>[];
    ...
    tester.binding.defaultBinaryMessenger
        .setMockMethodCallHandler(SystemChannels.mouseCursor, (_) async {
  ...
  testWidgetsWithLeakTracking(
      'No new frames are scheduled when mouse moves without triggering callbacks',
      (WidgetTester tester) async {
    await tester.pumpWidget(Center(
      child: MouseRegion(
        child: const SizedBox(
...
class _HoverClientWithClosures extends StatefulWidget {
  ...
  @override
  _HoverClientWithClosuresState createState() =>
      _HoverClientWithClosuresState();
}
