...
void main() {
  group('InteractiveViewer', () {
    ...
    testWidgetsWithLeakTracking('child fits in viewport',
      ...
      final Offset scaleStart2 =
          Offset(childInterior.dx + 10.0, childInterior.dy);
      final Offset scaleEnd1 =
          Offset(childInterior.dx - 10.0, childInterior.dy);
      final Offset scaleEnd2 =
          Offset(childInterior.dx + 20.0, childInterior.dy);
    ...
    testWidgetsWithLeakTracking('boundary slightly bigger than child',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('child bigger than viewport',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
      ...
      final Offset rotateStart2 =
          Offset(childInterior.dx + 10.0, childInterior.dy);
      final Offset rotateEnd1 =
          Offset(childInterior.dx + 5.0, childInterior.dy + 5.0);
      final Offset rotateEnd2 =
          Offset(childInterior.dx - 5.0, childInterior.dy - 5.0);
    ...
    testWidgetsWithLeakTracking('child has no dimensions',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    testWidgetsWithLeakTracking(
        'PanAxis.free allows panning in all directions for diagonal gesture',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    testWidgetsWithLeakTracking(
        'PanAxis.aligned allows panning in one direction only for diagonal gesture',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    testWidgetsWithLeakTracking('inertia fling and boundary sliding',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking(
      ...
      final Offset sceneFocalPoint =
          transformationController.toScene(viewportFocalPoint);
      gesture = await tester.createGesture();
      ...
      await gesture2.up();
      await tester.pumpAndSettle();
      final Offset newSceneFocalPoint =
          transformationController.toScene(viewportFocalPoint);
      expect(newSceneFocalPoint.dx,
          moreOrLessEquals(sceneFocalPoint.dx, epsilon: 1.0));
      expect(newSceneFocalPoint.dy,
          moreOrLessEquals(sceneFocalPoint.dy, epsilon: 1.0));
    });
    ...
    testWidgetsWithLeakTracking('Can scale with mouse',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
      ...
      expect(
          transformationController.value.getMaxScaleOnAxis(), greaterThan(1.0));
    });
    ...
    testWidgetsWithLeakTracking(
      ...
      final Offset scenePoint =
          transformationController.toScene(localFocalPoint);
    ...
    testWidgetsWithLeakTracking('onInteraction can be used to get scene point',
        (WidgetTester tester) async {
      late Offset focalPoint;
      late Offset localFocalPoint;
      late double scaleChange;
    ...
    testWidgetsWithLeakTracking(
      ...
      final TestGesture gesture =
          await tester.startGesture(childOffset, kind: PointerDeviceKind.mouse);
    ...
    testWidgetsWithLeakTracking('viewport changes size',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('gesture can start as pan and become scale',
        (WidgetTester tester) async {
      const double boundaryMargin = 50.0;
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgetsWithLeakTracking(
        'can view beyond boundary when necessary for a small child',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    testWidgetsWithLeakTracking(
        'scale does not jump when wrapped in GestureDetector',
        (WidgetTester tester) async {
      double? initialScale;
      double? scale;
      await tester.pumpWidget(
    ...
    testWidgetsWithLeakTracking('Check if ClipRect is present in the tree',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    testWidgetsWithLeakTracking(
                ...
                child: InteractiveViewer.builder(
                  ...
                  builder: (BuildContext context, Quad viewportQuad) {
                    ...
                    for (int i = 0; i < 10; i++) {
                      ...
                      final bool visible = (childBottom >= viewport.top &&
                              childBottom <= viewport.bottom) ||
                          (childTop >= viewport.top &&
                              childTop <= viewport.bottom);
      ...
      for (final Element element
          in find.byType(Container, skipOffstage: false).evaluate()) {
    ...
    testWidgetsWithLeakTracking('scaleFactor', (WidgetTester tester) async {
      ...
      await scrollAt(center, tester, const Offset(0.0, scrollAmount));
      await tester.pumpAndSettle();
      final double scaleLowZoomedOut =
          transformationController.value.getMaxScaleOnAxis();
      ...
      expect(scaleLowZoomedIn - scaleLowZoomedOut,
          greaterThan(scaleZoomedIn - scaleZoomedOut));
      ...
      await scrollAt(center, tester, const Offset(0.0, -scrollAmount));
      await tester.pumpAndSettle();
      final double scaleHighZoomedIn =
          transformationController.value.getMaxScaleOnAxis();
      expect(scaleHighZoomedIn, greaterThan(scaleHighZoomedOut));
      expect(scaleHighZoomedIn - scaleHighZoomedOut,
          lessThan(scaleZoomedIn - scaleZoomedOut));
    });

    testWidgetsWithLeakTracking('alignment argument is used properly',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('interactionEndFrictionCoefficient',
        (WidgetTester tester) async {
      // Use the default interactionEndFrictionCoefficient.
      final TransformationController transformationController1 =
      ...
      await tester.flingFrom(
          const Offset(100, 100), const Offset(0, -50), 100.0);
      await tester.pumpAndSettle();
      final Vector3 translation1 =
          transformationController1.value.getTranslation();
      expect(translation1.y, lessThan(-58.0));

      // Next try a custom interactionEndFrictionCoefficient.
      final TransformationController transformationController2 =
          TransformationController();
      ...
      await tester.flingFrom(
          const Offset(100, 100), const Offset(0, -50), 100.0);
      await tester.pumpAndSettle();
      final Vector3 translation2 =
          transformationController2.value.getTranslation();
    ...
    testWidgetsWithLeakTracking('discrete scroll pointer events',
        (WidgetTester tester) async {
      const double boundaryMargin = 50.0;
      await tester.pumpWidget(
        MaterialApp(
      ...
      await tester.sendEventToBinding(
          mouse.hover(tester.getCenter(find.byType(SizedBox))));
      ...
      await tester.sendEventToBinding(
          trackpad.hover(tester.getCenter(find.byType(SizedBox))));
    ...
    testWidgetsWithLeakTracking('discrete scale pointer event',
        (WidgetTester tester) async {
      const double boundaryMargin = 50.0;
      await tester.pumpWidget(
        MaterialApp(
      ...
      await tester.sendEventToBinding(
          pointer.hover(tester.getCenter(find.byType(SizedBox))));
      ...
      await tester.pump();
      expect(transformationController.value.getMaxScaleOnAxis(),
          2.5); // capped at maxScale (2.5)
    });

    testWidgetsWithLeakTracking('trackpadScrollCausesScale',
        (WidgetTester tester) async {
      const double boundaryMargin = 50.0;
      await tester.pumpWidget(
        MaterialApp(
      ...
      expect(transformationController.value.getMaxScaleOnAxis(), 1.0);
      await tester.sendEventToBinding(
          pointer.panZoomUpdate(center, pan: const Offset(0, -81)));
      await tester.pump();
      expect(transformationController.value.getMaxScaleOnAxis(),
      ...
      await tester.sendEventToBinding(
          pointer.panZoomUpdate(center, pan: const Offset(81, -81)));
      await tester.pump();
      expect(transformationController.value.getMaxScaleOnAxis(),
          moreOrLessEquals(1.499302500056767));
    });

    testWidgetsWithLeakTracking('trackpad pointer scroll events cause scale',
        (WidgetTester tester) async {
      const double boundaryMargin = 50.0;
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgetsWithLeakTracking('Scaling inertia', (WidgetTester tester) async {
      ...
      await tester.trackpadFling(
          find.byType(InteractiveViewer), const Offset(0, -100), 3000);
      await tester.pump();
      expect(transformationController.value.getMaxScaleOnAxis(),
  ...
  group('getNearestPointOnLine', () {
    test('does not modify parameters', () {
      ...
      final Vector3 closestPoint =
          InteractiveViewer.getNearestPointOnLine(point, a, b);
    ...
    test('simple example', () {
      ...
      expect(InteractiveViewer.getNearestPointOnLine(point, a, b),
          Vector3(2.5, 2.5, 0.0));
    });
  ...
  group('getNearestPointInside', () {
    test('point already inside quad', () {
      ...
      final Vector3 nearestPoint =
          InteractiveViewer.getNearestPointInside(point, quad);
