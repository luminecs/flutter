...
void main() {
  ...
  testWidgetsWithLeakTracking('thumb resizes gradually on overscroll',
  ...
  testWidgetsWithLeakTracking('Scrollbar does not fade away while hovering',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking(
      'Scrollbar will fade back in when hovering over known track area',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('Scrollbar thumb can be dragged',
      (WidgetTester tester) async {
    final ScrollController scrollController = ScrollController();
    addTearDown(scrollController.dispose);
    await tester.pumpWidget(
  ...
  testWidgetsWithLeakTracking('Scrollbar thumb can be dragged in reverse',
      (WidgetTester tester) async {
    final ScrollController scrollController = ScrollController();
    addTearDown(scrollController.dispose);
    await tester.pumpWidget(
  ...
  testWidgetsWithLeakTracking(
      'RawScrollbar mainAxisMargin property works properly',
      (WidgetTester tester) async {
    final ScrollController scrollController = ScrollController();
    addTearDown(scrollController.dispose);
    await tester.pumpWidget(
  ...
  testWidgetsWithLeakTracking(
      'The bar can show or hide when the view size change',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('notificationPredicate depth test.',
      (WidgetTester tester) async {
    final ScrollController scrollController = ScrollController();
    addTearDown(scrollController.dispose);
  ...
  testWidgetsWithLeakTracking('Scrollbar track can be drawn',
      (WidgetTester tester) async {
    final ScrollController scrollController = ScrollController();
    addTearDown(scrollController.dispose);
    await tester.pumpWidget(
  ...
  testWidgetsWithLeakTracking('RawScrollbar correctly assigns colors',
      (WidgetTester tester) async {
    final ScrollController scrollController = ScrollController();
    addTearDown(scrollController.dispose);
    await tester.pumpWidget(
  ...
  testWidgetsWithLeakTracking('Track offset respects MediaQuery padding',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'RawScrollbar.padding replaces MediaQueryData.padding',
      (WidgetTester tester) async {
    final ScrollController scrollController = ScrollController();
    addTearDown(scrollController.dispose);
    await tester.pumpWidget(Directionality(
  ...
  testWidgetsWithLeakTracking('The bar support mouse wheel event',
      (WidgetTester tester) async {
