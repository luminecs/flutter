...
void main() {
  testWidgetsWithLeakTracking('Semantics can merge sibling group',
    ...
    ChildSemanticsConfigurationsResult delegate(
        List<SemanticsConfiguration> configs) {
  ...
  testWidgetsWithLeakTracking('Semantics can drop semantics config',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    const SemanticsTag first = SemanticsTag('1');
    const SemanticsTag second = SemanticsTag('2');
  ...
  testWidgetsWithLeakTracking(
      'Semantics throws when mark the same config twice case 2',
      (WidgetTester tester) async {
    const SemanticsTag first = SemanticsTag('1');
    const SemanticsTag second = SemanticsTag('2');
    const SemanticsTag third = SemanticsTag('3');
  ...
  testWidgetsWithLeakTracking(
      'RenderObject with semantics child delegate will mark correct boundary dirty',
      (WidgetTester tester) async {
    ...
    final RenderMarkSemanticsDirtySpy innerObject =
        tester.renderObject<RenderMarkSemanticsDirtySpy>(find.byKey(inner));
    final RenderTestConfigDelegate objectWithDelegate =
        tester.renderObject<RenderTestConfigDelegate>(
    ...
    final RenderMarkSemanticsDirtySpy grandBoundaryParentObject =
        tester.renderObject<RenderMarkSemanticsDirtySpy>(
...
class TestConfigDelegate extends SingleChildRenderObjectWidget {
  ...
  void updateRenderObject(
      BuildContext context, RenderTestConfigDelegate renderObject) {
