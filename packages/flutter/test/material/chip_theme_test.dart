...
void main() {
  ...
  testWidgetsWithLeakTracking('Default ChipThemeData debugFillProperties',
  ...
  testWidgetsWithLeakTracking('ChipThemeData implements debugFillProperties',
      (WidgetTester tester) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
    const ChipThemeData(
  ...
  testWidgetsWithLeakTracking('Chip uses ThemeData chip theme',
      (WidgetTester tester) async {
    ...
    expect(tester.getSize(find.byType(RawChip)),
        const Size(250, 250)); // label + padding + labelPadding
    expect(getMaterial(tester).shape, chipTheme.shape);
    expect(getLabelStyle(tester).style.fontSize, 32);
  });

  testWidgetsWithLeakTracking('Chip uses ChipTheme',
      (WidgetTester tester) async {
    const ChipThemeData chipTheme = ChipThemeData(
      backgroundColor: Color(0xff112233),
      elevation: 4,
  ...
  testWidgetsWithLeakTracking('Chip uses constructor parameters',
      (WidgetTester tester) async {
    const ChipThemeData shadowedChipTheme = ChipThemeData(
      backgroundColor: Color(0xff112233),
      elevation: 4,
  ...
  testWidgetsWithLeakTracking('ChipTheme.fromDefaults',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('ChipThemeData lerps correctly',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Chip uses stateful color from chip theme',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Chip uses stateful border side from resolveWith pattern',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Chip uses stateful border side from chip theme',
      (WidgetTester tester) async {
    const Color selectedColor = Color(0x00000001);
    const Color defaultColor = Color(0x00000002);
  ...
  testWidgetsWithLeakTracking('Chip uses stateful shape from chip theme',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'RawChip uses material state color from ChipTheme',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RawChip uses state colors from ChipTheme',
      (WidgetTester tester) async {
    const ChipThemeData chipTheme = ChipThemeData(
  ...
  testWidgetsWithLeakTracking(
      'RawChip respects checkmark properties from ChipTheme',
      (WidgetTester tester) async {
