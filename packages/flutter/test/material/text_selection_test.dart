...
void main() {
  ...
  group('canSelectAll', () {
    ...
    testWidgetsWithLeakTracking('should return false when there is no text',
        (WidgetTester tester) async {
      final GlobalKey<EditableTextState> key = GlobalKey();
      await tester.pumpWidget(createEditableText(key: key));
      expect(
          materialTextSelectionControls.canSelectAll(key.currentState!), false);
    });
    ...
    testWidgetsWithLeakTracking(
      ...
      expect(
          materialTextSelectionControls.canSelectAll(key.currentState!), true);
    });
  ...
  group('menu position', () {
    ...
    testWidgetsWithLeakTracking(
      ...
      (WidgetTester tester) async {
        ...
        expect(
            selectionOffset.dy + 44.0 + 8.0 - 8.0, equals(textFieldOffset.dy));
      },
  ...
  group('material handles', () {
    testWidgetsWithLeakTracking('draws transparent handle correctly',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('works with 3 positional parameters',
        (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Paste only appears when clipboard has contents',
      (WidgetTester tester) async {
    ...
    expect(find.text('Select all'), findsOneWidget);
      ...
      skip:
          isBrowser, // [intended] we don't supply the cut/copy/paste buttons on the web.
