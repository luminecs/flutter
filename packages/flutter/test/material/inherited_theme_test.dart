...
void main() {
  ...
  testWidgetsWithLeakTracking('PopupMenuTheme.wrap()',
  ...
  testWidgetsWithLeakTracking('BannerTheme.wrap()',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('DividerTheme.wrap()',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('ListTileTheme.wrap()',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('SliderTheme.wrap()',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('ToggleButtonsTheme.wrap()',
      (WidgetTester tester) async {
