...
void main() {
  ...
  testWidgetsWithLeakTracking('Dialog is scrollable',
  ...
  testWidgetsWithLeakTracking('Dialog background color from AlertDialog',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Dialog.fullscreen Defaults',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Custom dialog elevation',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Custom Title Text Style',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Custom Content Text Style',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('AlertDialog custom clipBehavior',
      (WidgetTester tester) async {
    const AlertDialog dialog = AlertDialog(
      actions: <Widget>[],
  ...
  testWidgetsWithLeakTracking('SimpleDialog custom clipBehavior',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Custom dialog shape',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Rectangular dialog shape',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Custom dialog alignment',
      (WidgetTester tester) async {
    const AlertDialog dialog = AlertDialog(
      actions: <Widget>[],
  ...
  testWidgetsWithLeakTracking('Simple dialog control test',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Can show dialog using navigator global key',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Custom padding on SimpleDialogOption',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Barrier dismissible',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
  ...
  testWidgetsWithLeakTracking('Dialog hides underlying semantics tree',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('AlertDialog.actionsPadding defaults',
      (WidgetTester tester) async {
    final AlertDialog dialog = AlertDialog(
      title: const Text('title'),
  ...
  testWidgetsWithLeakTracking(
      'AlertDialog.actionsPadding surrounds actions with padding',
      (WidgetTester tester) async {
    final AlertDialog dialog = AlertDialog(
      title: const Text('title'),
      content: const Text('content'),
  ...
  testWidgetsWithLeakTracking('AlertDialog.buttonPadding defaults',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('AlertDialog.buttonPadding custom values',
      (WidgetTester tester) async {
    final GlobalKey key1 = GlobalKey();
    final GlobalKey key2 = GlobalKey();
  ...
  testWidgetsWithLeakTracking(
      'Dialogs can set the vertical direction of overflowing actions',
      (WidgetTester tester) async {
    final GlobalKey key1 = GlobalKey();
    final GlobalKey key2 = GlobalKey();
  ...
  testWidgetsWithLeakTracking(
      'Dialogs have no spacing by default for overflowing actions',
      (WidgetTester tester) async {
    final GlobalKey key1 = GlobalKey();
    final GlobalKey key2 = GlobalKey();
  ...
  testWidgetsWithLeakTracking(
      'Dialogs can set the button spacing of overflowing actions',
      (WidgetTester tester) async {
    final GlobalKey key1 = GlobalKey();
    final GlobalKey key2 = GlobalKey();
  ...
  testWidgetsWithLeakTracking('Dialog widget insets by viewInsets',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MediaQuery(
        data: MediaQueryData(
  ...
  testWidgetsWithLeakTracking('Dialog insetPadding added to outside of dialog',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('SimpleDialog does not introduce additional node',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgetsWithLeakTracking(
      'showDialog only gets Theme from context on the first call',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('showDialog safe area',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgetsWithLeakTracking('showDialog uses root navigator by default',
      (WidgetTester tester) async {
  ...
  group('AlertDialog.scrollable: ', () {
    testWidgetsWithLeakTracking('Title is scrollable',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('Content is scrollable',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('Title and content are scrollable',
        (WidgetTester tester) async {
      final Key titleKey = UniqueKey();
      final Key contentKey = UniqueKey();
      final AlertDialog dialog = AlertDialog(
  ...
  testWidgetsWithLeakTracking('Dialog with RouteSettings',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('showDialog - custom barrierLabel',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgetsWithLeakTracking('DialogRoute is state restorable',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
  ...
  testWidgetsWithLeakTracking('AlertDialog.actionsAlignment',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Adaptive AlertDialog shows correct widget on each platform',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Uses open focus traversal when overridden',
      (WidgetTester tester) async {
    final FocusNode okNode = FocusNode();
