...
void main() {
  testWidgetsWithLeakTracking('CircleAvatar with dark background color',
    ...
    expect(paragraph.text.style!.color,
        equals(ThemeData.fallback().primaryColorLight));
  });

  testWidgetsWithLeakTracking('CircleAvatar with light background color',
      (WidgetTester tester) async {
    ...
    final RenderParagraph paragraph = tester.renderObject(find.text('Z'));
    expect(paragraph.text.style!.color,
        equals(ThemeData.fallback().primaryColorDark));
  });

  testWidgetsWithLeakTracking('CircleAvatar with image background',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      wrap(
        child: CircleAvatar(
  ...
  testWidgetsWithLeakTracking('CircleAvatar with image foreground',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      wrap(
        child: CircleAvatar(
        ...
        child: RepaintBoundary(
          child: CircleAvatar(
            ...
            onForegroundImageError: (_, __) =>
                caughtForegroundImageError = true,
          ),
        ),
      ),
    );
  ...
  testWidgetsWithLeakTracking('CircleAvatar with foreground color',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('CircleAvatar default colors',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('CircleAvatar respects minRadius',
      (WidgetTester tester) async {
    final Color backgroundColor = Colors.blue.shade900;
    await tester.pumpWidget(
      wrap(
  ...
  testWidgetsWithLeakTracking('CircleAvatar respects maxRadius',
      (WidgetTester tester) async {
    final Color backgroundColor = Colors.blue.shade900;
    await tester.pumpWidget(
      wrap(
  ...
  testWidgetsWithLeakTracking(
      'CircleAvatar respects setting both minRadius and maxRadius',
      (WidgetTester tester) async {
    final Color backgroundColor = Colors.blue.shade900;
    await tester.pumpWidget(
      wrap(
  ...
  group('Material 2', () {
    ...
    testWidgetsWithLeakTracking('CircleAvatar default colors with light theme',
        (WidgetTester tester) async {
      final ThemeData theme =
          ThemeData(useMaterial3: false, primaryColor: Colors.grey.shade100);
      await tester.pumpWidget(
        wrap(
          child: Theme(
            data: theme,
      ...
      final RenderParagraph paragraph = tester.renderObject(find.text('Z'));
      expect(paragraph.text.style!.color,
          equals(theme.primaryTextTheme.titleLarge!.color));
    });

    testWidgetsWithLeakTracking('CircleAvatar default colors with dark theme',
        (WidgetTester tester) async {
      final ThemeData theme =
          ThemeData(useMaterial3: false, primaryColor: Colors.grey.shade800);
      await tester.pumpWidget(
        wrap(
          child: Theme(
            data: theme,
...
Widget wrap({required Widget child}) {
  return Directionality(
    ...
    child: MediaQuery(
      data: const MediaQueryData(),
      child: MaterialApp(
          theme: ThemeData(useMaterial3: false), home: Center(child: child)),
    ),
  );
}
