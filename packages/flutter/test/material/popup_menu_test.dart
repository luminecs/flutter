...
void main() {
  testWidgetsWithLeakTracking('Navigator.push works within a PopupMenuButton',
  ...
  testWidgetsWithLeakTracking('disabled PopupMenuButton is not focusable',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'PopupMenuItem onTap callback is called when defined',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PopupMenuItem can have both onTap and value',
      (WidgetTester tester) async {
    final List<int> menuItemTapCounters = <int>[0, 0];
    String? selected;
  ...
  testWidgetsWithLeakTracking('PopupMenuItem is only focusable when enabled',
      (WidgetTester tester) async {
    final Key popupButtonKey = UniqueKey();
    final GlobalKey childKey = GlobalKey();
    bool itemBuilderCalled = false;
  ...
  testWidgetsWithLeakTracking('PopupMenuButton is horizontal on iOS',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PopupMenu positioning',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PopupMenu positioning inside nested Overlay',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PopupMenu positioning inside nested Navigator',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
  ...
  testWidgetsWithLeakTracking('PopupMenu positioning around display features',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
  ...
  testWidgetsWithLeakTracking('PopupMenu removes MediaQuery padding',
      (WidgetTester tester) async {
    late BuildContext popupContext;
  ...
  testWidgetsWithLeakTracking('Popup Menu Offset Test',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Opened PopupMenu has correct semantics',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Disabled PopupMenuItem has correct semantics',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PopupMenuButton PopupMenuDivider',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material3 - PopupMenuItem default padding',
      (WidgetTester tester) async {
    final Key popupMenuButtonKey = UniqueKey();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgetsWithLeakTracking('Material2 - PopupMenuItem default padding',
      (WidgetTester tester) async {
    final Key popupMenuButtonKey = UniqueKey();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgetsWithLeakTracking('PopupMenuItem custom padding',
      (WidgetTester tester) async {
    final Key popupMenuButtonKey = UniqueKey();
    final Type menuItemType =
        const PopupMenuItem<String>(child: Text('item')).runtimeType;
  ...
  testWidgetsWithLeakTracking('CheckedPopupMenuItem custom padding',
      (WidgetTester tester) async {
    final Key popupMenuButtonKey = UniqueKey();
    final Type menuItemType =
        const CheckedPopupMenuItem<String>(child: Text('item')).runtimeType;
  ...
  testWidgetsWithLeakTracking('PopupMenuButton default tooltip',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
  ...
  testWidgetsWithLeakTracking('PopupMenuButton custom tooltip',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
  ...
  testWidgetsWithLeakTracking('Allow Widget for PopupMenuButton.icon',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
  ...
  testWidgetsWithLeakTracking('showMenu uses nested navigator by default',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PopupMenuButton calling showButtonMenu manually',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PopupMenuItem changes mouse cursor when hovered',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PopupMenu position test when have unsafe area',
      (WidgetTester tester) async {
  ...
  group('feedback', () {
    ...
    testWidgetsWithLeakTracking('PopupMenuButton enableFeedback works properly',
        (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Can customize PopupMenuButton icon',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('does not crash in small overlay',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('The menu position test in the scrollable widget',
      (WidgetTester tester) async {
    final GlobalKey buttonKey = GlobalKey();
  ...
  testWidgetsWithLeakTracking('PopupMenuButton custom splash radius',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Can override menu size constraints',
      (WidgetTester tester) async {
    final Key popupMenuButtonKey = UniqueKey();
    final Type menuItemType =
        const PopupMenuItem<String>(child: Text('item')).runtimeType;
  ...
  testWidgetsWithLeakTracking('Can change menu position and offset',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking("PopupMenuButton icon inherits IconTheme's size",
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Popup menu clip behavior',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Uses closed loop focus traversal',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Popup menu scrollbar inherits ScrollbarTheme',
      (WidgetTester tester) async {
    final Key popupButtonKey = UniqueKey();
  ...
  testWidgetsWithLeakTracking('Popup menu with RouteSettings',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Popup menu is positioned under the child',
      (WidgetTester tester) async {
    final Key popupButtonKey = UniqueKey();
  ...
  testWidgetsWithLeakTracking(
      'PopupMenuItem onTap should be calling after Navigator.pop',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking(
      'CheckedPopupMenuItem.labelTextStyle resolve material states',
      (WidgetTester tester) async {
    final Key popupMenuButtonKey = UniqueKey();
  ...
  testWidgetsWithLeakTracking(
      'PopupMenuItem overrides redundant ListTile.contentPadding',
      (WidgetTester tester) async {
    final Key popupMenuButtonKey = UniqueKey();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgetsWithLeakTracking(
      'Material3 - PopupMenuItem overrides ListTile.titleTextStyle',
      (WidgetTester tester) async {
    final Key popupMenuButtonKey = UniqueKey();
    ThemeData theme = ThemeData(useMaterial3: true);
  ...
  testWidgetsWithLeakTracking(
      'Material2 - PopupMenuItem overrides ListTile.titleTextStyle',
      (WidgetTester tester) async {
    final Key popupMenuButtonKey = UniqueKey();
    ...
    expect(
        _labelStyle(tester, 'Item 0')!.color, theme.textTheme.subtitle1!.color);

    // Test popup menu item with a ListTile widget.
    expect(_labelStyle(tester, 'Item 1')!.fontSize, 16.0);
    expect(
        _labelStyle(tester, 'Item 1')!.color, theme.textTheme.subtitle1!.color);
  ...
  testWidgetsWithLeakTracking(
      'CheckedPopupMenuItem.onTap callback is called when defined',
      (WidgetTester tester) async {
    int count = 0;
    await tester.pumpWidget(
      TestApp(
