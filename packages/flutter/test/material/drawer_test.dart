...
void main() {
  ...
  testWidgetsWithLeakTracking('Drawer default shape (ltr)',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgetsWithLeakTracking('Drawer default shape (rtl)',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: true),
  ...
  testWidgetsWithLeakTracking('Drawer clip behavior',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: true),
  ...
  group('Material 2', () {
    ...
    testWidgetsWithLeakTracking('Drawer default shape',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(useMaterial3: false),
