...
void main() {
  testWidgetsWithLeakTracking('RawMaterialButton responds when tapped',
  ...
  testWidgetsWithLeakTracking('off-center child is hit testable',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Column(
  ...
  testWidgetsWithLeakTracking('smaller child is hit testable',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RawMaterialButton handles focus',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RawMaterialButton loses focus when disabled.',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      "Disabled RawMaterialButton can't be traversed to.",
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RawMaterialButton handles hover',
      (WidgetTester tester) async {
    const Key key = Key('test');
  ...
  testWidgetsWithLeakTracking('RawMaterialButton responds to density changes.',
      (WidgetTester tester) async {
    const Key key = Key('test');
  ...
  testWidgetsWithLeakTracking(
      'RawMaterialButton changes mouse cursor when hovered',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
