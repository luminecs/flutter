...
void main() {
  ...
  testWidgetsWithLeakTracking('RadioListTile simple control test',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RadioListTile control tests',
      (WidgetTester tester) async {
    final List<int> values = <int>[0, 1, 2];
    int? selectedValue;
  ...
  testWidgetsWithLeakTracking(
      'Selected RadioListTile should trigger onChanged when toggleable',
      (WidgetTester tester) async {
    final List<int> values = <int>[0, 1, 2];
    int? selectedValue;
    // Constructor parameters are required for [Radio], but they are irrelevant
  ...
  testWidgetsWithLeakTracking('RadioListTile semantics',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RadioListTile has semantic events',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    final Key key = UniqueKey();
  ...
  testWidgetsWithLeakTracking('RadioListTile can autofocus unless disabled.',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RadioListTile contentPadding test',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RadioListTile respects shape',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RadioListTile respects tileColor',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RadioListTile respects selectedTileColor',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RadioListTile selected item text Color',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RadioListTile respects visualDensity',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('RadioListTile respects focusNode',
      (WidgetTester tester) async {
    final GlobalKey childKey = GlobalKey();
    await tester.pumpWidget(
      wrap(
  ...
  testWidgetsWithLeakTracking('RadioListTile onFocusChange callback',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Radio changes mouse cursor when hovered',
    ...
    await gesture.addPointer(
        location: tester.getCenter(find.byType(Radio<int>)));
  ...
  testWidgetsWithLeakTracking('Material3 - RadioListTile respects hoverColor',
      (WidgetTester tester) async {
    tester.binding.focusManager.highlightStrategy =
        FocusHighlightStrategy.alwaysTraditional;
    int? groupValue = 0;
  ...
  testWidgetsWithLeakTracking(
      'Material3 - RadioListTile respects overlayColor in active/pressed/hovered states',
      (WidgetTester tester) async {
    tester.binding.focusManager.highlightStrategy =
        FocusHighlightStrategy.alwaysTraditional;
  ...
  testWidgetsWithLeakTracking('RadioListTile respects splashRadius',
      (WidgetTester tester) async {
    tester.binding.focusManager.highlightStrategy =
        FocusHighlightStrategy.alwaysTraditional;
  ...
  testWidgetsWithLeakTracking('Radio respects materialTapTargetSize',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      wrap(
          child: RadioListTile<bool>(
  ...
  group('feedback', () {
    ...
    testWidgetsWithLeakTracking('RadioListTile respects enableFeedback',
        (WidgetTester tester) async {
      const Key key = Key('test');
  ...
  group('Material 2', () {
    ...
    testWidgetsWithLeakTracking('Material2 - RadioListTile respects hoverColor',
        (WidgetTester tester) async {
      tester.binding.focusManager.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
      int? groupValue = 0;
