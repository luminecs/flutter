...
void main() {
  ...
  testWidgetsWithLeakTracking('Default DataTableThemeData debugFillProperties',
  ...
  testWidgetsWithLeakTracking(
    ...
    expect(description[1],
        "dataRowColor: Instance of '_MaterialStatePropertyWith<Color>'");
    ...
    expect(description[5],
        "headingRowColor: Instance of '_MaterialStatePropertyWith<Color>'");
    ...
    expect(description[12],
        'headingCellCursor: MaterialStatePropertyAll(SystemMouseCursor(grab))');
    expect(description[13],
        'dataRowCursor: MaterialStatePropertyAll(SystemMouseCursor(forbidden))');
  });

  testWidgetsWithLeakTracking('DataTable is themeable',
      (WidgetTester tester) async {
