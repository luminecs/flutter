...
void main() {
  test('ProgressIndicatorThemeData copyWith, ==, hashCode, basics', () {
    expect(const ProgressIndicatorThemeData(),
        const ProgressIndicatorThemeData().copyWith());
    expect(const ProgressIndicatorThemeData().hashCode,
  ...
  test('ProgressIndicatorThemeData lerp special cases', () {
    ...
    expect(identical(ProgressIndicatorThemeData.lerp(data, data, 0.5), data),
        true);
  });
}
