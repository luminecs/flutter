...
void main() {
  ...
  group('Material 2 tests', () {
    testWidgetsWithLeakTracking('Material2 - BAB theme overrides color',
    ...
    testWidgetsWithLeakTracking('Material2 - BAB color - Widget',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('Material2 - BAB color - BabTheme',
        (WidgetTester tester) async {
      const Color themeColor = Colors.white10;
      const Color babThemeColor = Colors.black87;
      const BottomAppBarTheme theme = BottomAppBarTheme(color: babThemeColor);
    ...
    testWidgetsWithLeakTracking('Material2 - BAB color - Theme',
        (WidgetTester tester) async {
      const Color themeColor = Colors.white10;
    ...
    testWidgetsWithLeakTracking('Material2 - BAB color - Default',
        (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
    ...
    testWidgetsWithLeakTracking('Material2 - BAB theme customizes shape',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking(
        'Material2 - BAB theme does not affect defaults',
        (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(useMaterial3: false),
        home: const Scaffold(body: BottomAppBar()),
  ...
  group('Material 3 tests', () {
    testWidgetsWithLeakTracking('Material3 - BAB theme overrides color',
        (WidgetTester tester) async {
      const Color themedColor = Colors.black87;
      const BottomAppBarTheme theme =
          BottomAppBarTheme(color: themedColor, elevation: 0);
    ...
    testWidgetsWithLeakTracking('Material3 - BAB color - Widget',
        (WidgetTester tester) async {
      const Color themeColor = Colors.white10;
      const Color babThemeColor = Colors.black87;
      const Color babColor = Colors.pink;
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: const Scaffold(
            body: BottomAppBar(
                color: babColor, surfaceTintColor: Colors.transparent)),
      ));
    ...
    testWidgetsWithLeakTracking('Material3 - BAB color - BabTheme',
        (WidgetTester tester) async {
      const Color themeColor = Colors.white10;
      const Color babThemeColor = Colors.black87;
      const BottomAppBarTheme theme = BottomAppBarTheme(color: babThemeColor);
    ...
    testWidgetsWithLeakTracking(
        'Material3 - BAB theme does not affect defaults',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking(
        'Material3 - BAB theme overrides surfaceTintColor',
        (WidgetTester tester) async {
      const Color color =
      ...
      expect(
          ...
          ElevationOverlay.applySurfaceTint(
              color, babThemeSurfaceTintColor, 0));
    });

    testWidgetsWithLeakTracking('Material3 - BAB theme overrides shadowColor',
        (WidgetTester tester) async {
      const Color babThemeShadowColor = Colors.yellow;
      const BottomAppBarTheme theme =
          BottomAppBarTheme(shadowColor: babThemeShadowColor, elevation: 0);
      await tester.pumpWidget(_withTheme(theme, useMaterial3: true));
    ...
    testWidgetsWithLeakTracking('Material3 - BAB surfaceTintColor - Widget',
        (WidgetTester tester) async {
      const Color color =
      ...
      const BottomAppBarTheme theme =
          BottomAppBarTheme(surfaceTintColor: babThemeSurfaceTintColor);
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(
            useMaterial3: true,
            bottomAppBarTheme: theme,
        ...
        home: const Scaffold(
            body: BottomAppBar(
                color: color, surfaceTintColor: babSurfaceTintColor)),
      ));
    ...
    testWidgetsWithLeakTracking('Material3 - BAB surfaceTintColor - BabTheme',
        (WidgetTester tester) async {
      const Color color =
          Colors.blue; // base color that the surface tint will be applied to
      const Color themeColor = Colors.white10;
      const Color babThemeColor = Colors.black87;
      const BottomAppBarTheme theme =
          BottomAppBarTheme(surfaceTintColor: babThemeColor);
