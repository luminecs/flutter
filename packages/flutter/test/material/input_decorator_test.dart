...
void runAllTests({required bool useMaterial3}) {
  testWidgetsWithLeakTracking('InputDecorator input/label text layout',
  ...
  testWidgetsWithLeakTracking('InputDecorator input/label widget layout',
      (WidgetTester tester) async {
    const Key key = Key('l');
  ...
  group('alignLabelWithHint', () {
    group('expands false', () {
      testWidgetsWithLeakTracking('multiline TextField no-strut',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking('multiline TextField',
          (WidgetTester tester) async {
        const String text = 'text';
        final FocusNode focusNode = FocusNode();
        final TextEditingController controller = TextEditingController();
    ...
    group('expands true', () {
      ...
      testWidgetsWithLeakTracking('multiline TextField with outline border',
          (WidgetTester tester) async {
        const String text = 'text';
        final FocusNode focusNode = FocusNode();
        addTearDown(focusNode.dispose);
  ...
  //   16 - input text (font size 16dps)
  //   12 - bottom padding
  testWidgetsWithLeakTracking('InputDecorator input/hint layout',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('InputDecorator input/label/hint layout',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('InputDecorator input/label/hint dense layout',
      (WidgetTester tester) async {
    // Label is visible, hint is not (opacity 0.0).
    await tester.pumpWidget(
      buildInputDecorator(
  ...
  testWidgetsWithLeakTracking('InputDecorator default hint animation duration',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator custom hint animation duration',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking(
      'InputDecorator custom hint animation duration from theme',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator with no input border',
      (WidgetTester tester) async {
    // Label is visible, hint is not (opacity 0.0).
    await tester.pumpWidget(
      buildInputDecorator(
  ...
  testWidgetsWithLeakTracking('InputDecorator error/helper/counter layout',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator counter text, widget, and null',
      (WidgetTester tester) async {
    Widget buildFrame({
  ...
  testWidgetsWithLeakTracking('InputDecoration errorMaxLines',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('InputDecoration helperMaxLines',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('InputDecorator shows error text',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator shows error widget',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator prefix/suffix texts',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator icon/prefix/suffix',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking(
      'InputDecorator suffixIconColor in M3 error state',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'InputDecoration default floatingLabelStyle resolves hovered/focused states',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode();
    addTearDown(focusNode.dispose);
  ...
  testWidgetsWithLeakTracking('InputDecorator prefix/suffix widgets',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('InputDecorator tall prefix',
      (WidgetTester tester) async {
    const Key pKey = Key('p');
    await tester.pumpWidget(
      buildInputDecorator(
  ...
  testWidgetsWithLeakTracking('InputDecorator tall prefix with border',
      (WidgetTester tester) async {
    const Key pKey = Key('p');
    await tester.pumpWidget(
      buildInputDecorator(
  ...
  testWidgetsWithLeakTracking('InputDecorator prefixIcon/suffixIcon',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking(
      'InputDecorator prefixIconConstraints/suffixIconConstraints',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
    ...
    expect(
        tester.getTopLeft(find.byIcon(Icons.satellite)).dy, (32.0 - 25.0) / 2);
    expect(tester.getTopRight(find.byIcon(Icons.satellite)).dx, 800.0);
  });
  ...
  testWidgetsWithLeakTracking(
      'InputDecorator respects reduced theme visualDensity',
      (WidgetTester tester) async {
    // Label is visible, hint is not (opacity 0.0).
    await tester.pumpWidget(
      buildInputDecorator(
  ...
  testWidgetsWithLeakTracking(
      'InputDecorator respects increased theme visualDensity',
      (WidgetTester tester) async {
    // Label is visible, hint is not (opacity 0.0).
    await tester.pumpWidget(
      buildInputDecorator(
  ...
  group('constraints', () {
    testWidgetsWithLeakTracking('No InputDecorator constraints',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('InputDecoratorThemeData constraints',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        buildInputDecorator(
          useMaterial3: useMaterial3,
    ...
    testWidgetsWithLeakTracking('InputDecorator constraints',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        buildInputDecorator(
          useMaterial3: useMaterial3,
  ...
  group('textAlignVertical position', () {
    group('simple case', () {
      testWidgetsWithLeakTracking('align top (default)',
          (WidgetTester tester) async {
        const String text = 'text';
        await tester.pumpWidget(
          buildInputDecorator(
      ...
      testWidgetsWithLeakTracking('align as a double',
          (WidgetTester tester) async {
        const String text = 'text';
        await tester.pumpWidget(
          buildInputDecorator(
      ...
      testWidgetsWithLeakTracking('works with density and content padding',
          (WidgetTester tester) async {
    ...
    group('outline border', () {
      ...
      testWidgetsWithLeakTracking('align center (default)',
          (WidgetTester tester) async {
        const String text = 'text';
        await tester.pumpWidget(
          buildInputDecorator(
    ...
    group('prefix', () {
      testWidgetsWithLeakTracking('InputDecorator tall prefix align top',
          (WidgetTester tester) async {
        const Key pKey = Key('p');
        const String text = 'text';
        await tester.pumpWidget(
      ...
      testWidgetsWithLeakTracking('InputDecorator tall prefix align center',
          (WidgetTester tester) async {
        const Key pKey = Key('p');
        const String text = 'text';
        await tester.pumpWidget(
      ...
      testWidgetsWithLeakTracking('InputDecorator tall prefix align bottom',
          (WidgetTester tester) async {
        const Key pKey = Key('p');
        const String text = 'text';
        await tester.pumpWidget(
    ...
    group('outline border and prefix', () {
      ...
      testWidgetsWithLeakTracking(
          'InputDecorator tall prefix with border align top',
          (WidgetTester tester) async {
        const Key pKey = Key('p');
        const String text = 'text';
        await tester.pumpWidget(
      ...
      testWidgetsWithLeakTracking(
          'InputDecorator tall prefix with border align bottom',
          (WidgetTester tester) async {
        const Key pKey = Key('p');
        const String text = 'text';
        await tester.pumpWidget(
      ...
      testWidgetsWithLeakTracking(
          'InputDecorator tall prefix with border align double',
          (WidgetTester tester) async {
        const Key pKey = Key('p');
        const String text = 'text';
        await tester.pumpWidget(
  ...
  group('OutlineInputBorder', () {
    group('default alignment', () {
      testWidgetsWithLeakTracking('Centers when border',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(
            useMaterial3: useMaterial3,
      ...
      testWidgetsWithLeakTracking('Centers when border and label',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(
            useMaterial3: useMaterial3,
      ...
      testWidgetsWithLeakTracking('Centers when border and contentPadding',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(
            useMaterial3: useMaterial3,
      ...
      testWidgetsWithLeakTracking(
          'Centers when border and contentPadding and label',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(
            useMaterial3: useMaterial3,
      ...
      testWidgetsWithLeakTracking(
          'Centers when border and lopsided contentPadding and label',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(
            useMaterial3: useMaterial3,
      ...
      testWidgetsWithLeakTracking(
        ...
        expect(tester.getTopLeft(find.text('label')).dx,
            useMaterial3 ? 12.0 : 48.0);
        expect(tester.getBottomLeft(find.text('text')).dx, 48.0);
        expect(getBorderWeight(tester), 2.0);
      });

      testWidgetsWithLeakTracking(
          'Floating label for filled input decoration is aligned with text',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(
            useMaterial3: useMaterial3,
    ...
    group('3 point interpolation alignment', () {
      testWidgetsWithLeakTracking('top align includes padding',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(
            useMaterial3: useMaterial3,
      ...
      testWidgetsWithLeakTracking('center align ignores padding',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(
            useMaterial3: useMaterial3,
      ...
      testWidgetsWithLeakTracking('bottom align includes padding',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(
            useMaterial3: useMaterial3,
      ...
      testWidgetsWithLeakTracking('padding exceeds middle keeps top at middle',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(
            useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator error/helper/counter RTL layout',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator prefix/suffix RTL',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator contentPadding RTL layout',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('FloatingLabelAlignment.toString()',
      (WidgetTester tester) async {
  ...
  group('inputText width', () {
    testWidgetsWithLeakTracking('outline textField',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        buildInputDecorator(
          useMaterial3: useMaterial3,
    ...
    testWidgetsWithLeakTracking(
        'outline textField with prefix and suffix icons',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        buildInputDecorator(
          useMaterial3: useMaterial3,
    ...
    testWidgetsWithLeakTracking('filled textField',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        buildInputDecorator(
          useMaterial3: useMaterial3,
    ...
    testWidgetsWithLeakTracking('filled textField with prefix and suffix icons',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        buildInputDecorator(
          useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator prefix/suffix dense layout',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator with empty InputDecoration',
      (WidgetTester tester) async {
    await tester.pumpWidget(buildInputDecorator(
      useMaterial3: useMaterial3,
    ));
  ...
  testWidgetsWithLeakTracking('InputDecorator.collapsed',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator with baseStyle',
      (WidgetTester tester) async {
    ...
    expect(
        ...
        Size(
            ...
            useMaterial3
                ? 50.0
                : kMinInteractiveDimension)); // 45.5 bumped up to minimum.
    expect(tester.getSize(find.text('hint')).height, 10.0);
    expect(
        tester.getSize(find.text('label')).height, useMaterial3 ? 16.0 : 10.0);
  ...
  testWidgetsWithLeakTracking('InputDecorator with empty style overrides',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('InputDecorationTheme outline border',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorationTheme style overrides',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('InputDecorationTheme style overrides (focused)',
      (WidgetTester tester) async {
    const TextStyle defaultStyle = TextStyle(fontSize: 16.0);
    final TextStyle labelStyle =
        defaultStyle.merge(const TextStyle(color: Colors.red));
  ...
  testWidgetsWithLeakTracking('InputDecorator.toString()',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('InputDecorator.debugDescribeChildren',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        useMaterial3: useMaterial3,
  ...
  testWidgetsWithLeakTracking('InputDecorator with empty border and label',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('InputDecorationTheme.inputDecoration',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('InputDecorator constrained to 0x0',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('InputDecorator draws and animates hoverColor',
      (WidgetTester tester) async {
    final Color fillColor =
        useMaterial3 ? const Color(0xffffffff) : const Color(0x0A000000);
    const Color hoverColor = Color(0xFF00FF00);
    final Color disabledColor =
        useMaterial3 ? const Color(0x0A000000) : const Color(0x05000000);
    final Color enabledBorderColor =
        useMaterial3 ? const Color(0xffffffff) : const Color(0x61000000);
    ...
    final Color blendedHoverColor =
        useMaterial3 ? const Color(0xff000000) : const Color(0x74004400);
  ...
  testWidgetsWithLeakTracking('InputDecorator draws and animates focusColor',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'InputDecorator withdraws label when not empty or focused',
      (WidgetTester tester) async {
    Future<void> pumpDecorator({
      required bool focused,
      bool enabled = true,
  ...
  testWidgetsWithLeakTracking('InputDecoration default border uses colorScheme',
      (WidgetTester tester) async {
    final ThemeData theme =
        ThemeData.from(colorScheme: const ColorScheme.light());
    final Color enabledColor = useMaterial3
        ? theme.colorScheme.onSurfaceVariant
        : theme.colorScheme.onSurface.withOpacity(0.38);
    final Color disabledColor = useMaterial3
    ...
    expect(getBorderColor(tester),
        useMaterial3 ? theme.colorScheme.onSurfaceVariant : theme.hintColor);
  ...
  testWidgetsWithLeakTracking('InputDecoration borders',
      (WidgetTester tester) async {
    const InputBorder errorBorder = OutlineInputBorder(
      borderSide: BorderSide(color: Colors.red, width: 1.5),
    );
      ...
      paints
        ...
        ..path(
          ...
          includes: <Offset>[
            ...
            // Bottom-right arc
            const Offset(
                inputDecoratorWidth, inputDecoratorHeight - borderRadiusScaled),
            const Offset(
                inputDecoratorWidth - borderRadiusScaled, inputDecoratorHeight),
            // Top-right arc
  ...
  testWidgetsWithLeakTracking('OutlineInputBorder async lerp',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('uses alphabetic baseline for CJK layout',
      (WidgetTester tester) async {
    ...
    expect(
        tester.getBottomLeft(find.text('hint')).dy, isBrowser ? 45.75 : 47.75);
  });

  testWidgetsWithLeakTracking('InputDecorator floating label Y coordinate',
      (WidgetTester tester) async {
    ...
    expect(
      ...
      paints
        ..something((Symbol methodName, List<dynamic> arguments) {
          ...
          expect(
              clipRect,
              rectMoreOrLessEquals(const Rect.fromLTWH(0, 0, 100 / 0.75, 16.0),
                  epsilon: 1e-5));
          return true;
        }),
    );
  ...
  testWidgetsWithLeakTracking('textAlignVertical can be updated',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      "InputDecorator label width isn't affected by prefix or suffix",
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'visual density is included in the intrinsic height calculation',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('error message for negative baseline',
      (WidgetTester tester) async {
    ...
    expect(errorDetails?.toString(),
        contains("InputDecorator's children reported a negative baseline"));
    expect(errorDetails?.toString(), contains('RenderStack'));
  });

  testWidgetsWithLeakTracking(
      'min intrinsic height for TextField with no content padding',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'min intrinsic height for TextField with prefix icon',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'min intrinsic height for TextField with suffix icon',
      (WidgetTester tester) async {
    final TextEditingController controller =
        TextEditingController(text: 'input');
    addTearDown(controller.dispose);
  ...
  testWidgetsWithLeakTracking('min intrinsic height for TextField with prefix',
      (WidgetTester tester) async {
    final TextEditingController controller =
        TextEditingController(text: 'input');
    addTearDown(controller.dispose);
  ...
  testWidgetsWithLeakTracking('min intrinsic height for TextField with suffix',
      (WidgetTester tester) async {
    final TextEditingController controller =
        TextEditingController(text: 'input');
    addTearDown(controller.dispose);
  ...
  testWidgetsWithLeakTracking('min intrinsic height for TextField with icon',
      (WidgetTester tester) async {
    final TextEditingController controller =
        TextEditingController(text: 'input');
    addTearDown(controller.dispose);
  ...
  testWidgetsWithLeakTracking('hint style overflow works',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('prefixIcon in RTL with asymmetric padding',
      (WidgetTester tester) async {
