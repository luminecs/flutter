...
void main() {
  ...
  testWidgetsWithLeakTracking('PaginatedDataTable footer page number',
      (WidgetTester tester) async {
    int rowsPerPage = 2;
  ...
  testWidgetsWithLeakTracking('PaginatedDataTable control test',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PaginatedDataTable text alignment',
      (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: PaginatedDataTable(
  ...
  testWidgetsWithLeakTracking(
      'PaginatedDataTable with and without header and actions',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PaginatedDataTable with large text',
      (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: MediaQuery(
  ...
  testWidgetsWithLeakTracking('PaginatedDataTable footer scrolls',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PaginatedDataTable custom row height',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'PaginatedDataTable custom horizontal padding - checkbox',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PaginatedDataTable table fills Card width',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Items selected text uses secondary color',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PaginatedDataTable arrowHeadColor set properly',
      (WidgetTester tester) async {
    await binding.setSurfaceSize(const Size(800, 800));
    addTearDown(() => binding.setSurfaceSize(null));
  ...
  testWidgetsWithLeakTracking('OverflowBar header left alignment',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('PaginatedDataTable custom heading row color',
      (WidgetTester tester) async {
