...
void main() {
  testWidgetsWithLeakTracking('Navigation bar updates destinations when tapped',
  ...
  testWidgetsWithLeakTracking('NavigationBar can update background color',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('NavigationBar can update elevation',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('NavigationBar adds bottom padding to height',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Custom tooltips in NavigationBarDestination',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking('Navigation bar semantics',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material3 - Navigation indicator renders ripple',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Navigation indicator scale transform',
      (WidgetTester tester) async {
    int selectedIndex = 0;
  ...
  group('Material 2', () {
    ...
    testWidgetsWithLeakTracking('Destination icon does not rebuild when tapped',
        (WidgetTester tester) async {
