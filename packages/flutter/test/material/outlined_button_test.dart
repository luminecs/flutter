...
void main() {
  testWidgetsWithLeakTracking('OutlinedButton, OutlinedButton.icon defaults',
  ...
  testWidgetsWithLeakTracking(
      'OutlinedButton default overlayColor resolves pressed state',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Does OutlinedButton work with hover',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Does OutlinedButton work with focus',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Does OutlinedButton work with autofocus',
      (WidgetTester tester) async {
    const Color focusColor = Color(0xff001122);
  ...
  testWidgetsWithLeakTracking('OutlinedButton has no clip by default',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('OutlinedButton contributes semantics',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('OutlinedButton scales textScaleFactor',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Theme(
        data: ThemeData(useMaterial3: false),
  ...
  testWidgetsWithLeakTracking('OutlinedButton responds to density changes.',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Override OutlinedButton default padding',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: false),
  ...
  testWidgetsWithLeakTracking('M3 OutlinedButton has correct padding',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('M3 OutlinedButton.icon has correct padding',
      (WidgetTester tester) async {
    final Key key = UniqueKey();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgetsWithLeakTracking('Fixed size OutlinedButtons',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking(
      'OutlinedButton with NoSplash splashFactory paints nothing',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('OutlinedButton.icon does not overflow',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('OutlinedButton.icon icon,label layout',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
  ...
  testWidgetsWithLeakTracking('OutlinedButton maximumSize',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Fixed size OutlinedButton, same as minimumSize == maximumSize',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking('OutlinedButton statesController',
      (WidgetTester tester) async {
    testStatesController(null, tester);
  });

  testWidgetsWithLeakTracking('OutlinedButton.icon statesController',
      (WidgetTester tester) async {
    testStatesController(const Icon(Icons.add), tester);
  });

  testWidgetsWithLeakTracking('Disabled OutlinedButton statesController',
      (WidgetTester tester) async {
    int count = 0;
    void valueChanged() {
      count += 1;
