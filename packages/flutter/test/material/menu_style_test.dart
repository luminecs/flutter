...
void main() {
  ...
  Padding getMenuBarPadding(WidgetTester tester) {
    return tester.widget<Padding>(
      find
          .descendant(of: findMenuPanels(), matching: find.byType(Padding))
          .first,
    );
  }
  ...
  Material getMenuMaterial(WidgetTester tester) {
    return tester.widget<Material>(
      find
          .descendant(
              of: findMenuPanels().at(1), matching: find.byType(Material))
          .first,
    );
  }
  ...
  Padding getMenuPadding(WidgetTester tester) {
    return tester.widget<Padding>(
      find
          .descendant(
              of: findMenuPanels().at(1), matching: find.byType(Padding))
          .first,
    );
  }
  ...
  group('MenuStyle', () {
    ...
    testWidgetsWithLeakTracking('fixedSize affects geometry',
                ...
                MenuBarTheme(
                  ...
                  child: MenuTheme(
                    data: const MenuThemeData(
                      style: MenuStyle(
                        fixedSize:
                            MaterialStatePropertyAll<Size>(Size(100, 100)),
                      ),
                    ),
                    child: MenuBar(
      ...
      expect(tester.getRect(findMenuPanels().first),
          equals(const Rect.fromLTRB(100.0, 0.0, 700.0, 60.0)));
      expect(tester.getRect(findMenuPanels().first).size,
          equals(const Size(600.0, 60.0)));

      // MenuTheme affects menus.
      if (!kIsWeb || isCanvasKit) {
        // https://github.com/flutter/flutter/issues/99933
        expect(tester.getRect(findMenuPanels().at(1)),
            equals(const Rect.fromLTRB(104.0, 54.0, 204.0, 154.0)));
        expect(tester.getRect(findMenuPanels().at(1)).size,
            equals(const Size(100.0, 100.0)));
      }
    });

    testWidgetsWithLeakTracking('maximumSize affects geometry',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Material(
              ...
              children: <Widget>[
                MenuBarTheme(
                  data: const MenuBarThemeData(
                    style: MenuStyle(
                      maximumSize:
                          MaterialStatePropertyAll<Size>(Size(250, 40)),
                    ),
                  ),
                  child: MenuTheme(
                    data: const MenuThemeData(
    ...
    testWidgetsWithLeakTracking('minimumSize affects geometry',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Material(
              ...
              children: <Widget>[
                MenuBarTheme(
                  data: const MenuBarThemeData(
                    style: MenuStyle(
                      minimumSize:
                          MaterialStatePropertyAll<Size>(Size(400, 60)),
                    ),
                  ),
                  child: MenuTheme(
                    data: const MenuThemeData(
                      style: MenuStyle(
                        minimumSize:
                            MaterialStatePropertyAll<Size>(Size(300, 300)),
                      ),
                    ),
                    child: MenuBar(
                      children: createTestMenus(onPressed: (TestMenu menu) {}),
      ...
      expect(tester.getRect(findMenuPanels().first).size,
          equals(const Size(400.0, 60.0)));

      // MenuTheme affects menus.
      expect(tester.getRect(findMenuPanels().at(1)),
          equals(const Rect.fromLTRB(204.0, 54.0, 504.0, 354.0)));
      expect(tester.getRect(findMenuPanels().at(1)).size,
          equals(const Size(300.0, 300.0)));
    });

    testWidgetsWithLeakTracking('Material parameters are honored',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Material(
      ...
      expect(
          ...
          equals(
              const StadiumBorder(side: BorderSide(color: Colors.redAccent))));
              ...
              children: <Widget>[
                MenuBarTheme(
                  data: const MenuBarThemeData(
                    style: MenuStyle(
                      visualDensity:
                          VisualDensity(horizontal: 1.5, vertical: -1.5),
                    ),
                  ),
                  child: MenuTheme(
                    data: const MenuThemeData(
  ...
  final List<Widget> result = <Widget>[
    SubmenuButton(
      ...
      menuChildren: <Widget>[
        MenuItemButton(
          onPressed:
              onPressed != null ? () => onPressed(TestMenu.subMenu00) : null,
          shortcut: shortcuts[TestMenu.subMenu00],
          child: Text(TestMenu.subMenu00.label),
        ),
        MenuItemButton(
          onPressed:
              onPressed != null ? () => onPressed(TestMenu.subMenu01) : null,
          shortcut: shortcuts[TestMenu.subMenu01],
          child: Text(TestMenu.subMenu01.label),
        ),
        MenuItemButton(
          onPressed:
              onPressed != null ? () => onPressed(TestMenu.subMenu02) : null,
    ...
    SubmenuButton(
      ...
      menuChildren: <Widget>[
        MenuItemButton(
          onPressed:
              onPressed != null ? () => onPressed(TestMenu.subMenu10) : null,
          ...
          menuChildren: <Widget>[
            MenuItemButton(
              ...
              onPressed: onPressed != null
                  ? () => onPressed(TestMenu.subSubMenu110)
                  : null,
            ...
            MenuItemButton(
              onPressed: onPressed != null
                  ? () => onPressed(TestMenu.subSubMenu111)
                  : null,
            ...
            MenuItemButton(
              onPressed: onPressed != null
                  ? () => onPressed(TestMenu.subSubMenu112)
                  : null,
            ...
            MenuItemButton(
              onPressed: onPressed != null
                  ? () => onPressed(TestMenu.subSubMenu113)
                  : null,
        ...
        MenuItemButton(
          onPressed:
              onPressed != null ? () => onPressed(TestMenu.subMenu12) : null,
