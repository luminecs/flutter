...
void main() {
  group('FloatingActionButton', () {
    ...
    testWidgetsWithLeakTracking(
        'Material2 - theme: ThemeData.light(), enabled: true',
    ...
    testWidgetsWithLeakTracking(
        'Material3 - theme: ThemeData.light(), enabled: true',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking(
        'Material2 - theme: ThemeData.light(), enabled: false',
        (WidgetTester tester) async {
      final ThemeData theme = ThemeData.light(useMaterial3: false);
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgetsWithLeakTracking(
        'Material3 - theme: ThemeData.light(), enabled: false',
        (WidgetTester tester) async {
      final ThemeData theme = ThemeData.light(useMaterial3: true);
      await tester.pumpWidget(
        MaterialApp(
