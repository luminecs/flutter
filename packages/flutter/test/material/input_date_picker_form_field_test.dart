...
void main() {
  ...
  group('InputDatePickerFormField', () {
    ...
    testWidgetsWithLeakTracking('Valid date entry',
        (WidgetTester tester) async {
      final GlobalKey<FormState> formKey = GlobalKey<FormState>();
      DateTime? inputDate;
      await tester.pumpWidget(inputDatePickerField(
    ...
    testWidgetsWithLeakTracking('Invalid text entry shows errorFormat text',
        (WidgetTester tester) async {
      final GlobalKey<FormState> formKey = GlobalKey<FormState>();
      DateTime? inputDate;
      await tester.pumpWidget(inputDatePickerField(
    ...
    testWidgetsWithLeakTracking('Empty field shows hint text when focused',
        (WidgetTester tester) async {
      await tester.pumpWidget(inputDatePickerField());
      // Focus on it
    ...
    testWidgetsWithLeakTracking('InputDecorationTheme is honored',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('Date text localization',
        (WidgetTester tester) async {
