...
void main() {
  test('ElevatedButtonThemeData lerp special cases', () {
    ...
    expect(
        identical(ElevatedButtonThemeData.lerp(data, data, 0.5), data), true);
  });

  testWidgetsWithLeakTracking(
      'Material3: Passing no ElevatedButtonTheme returns defaults',
  ...
  testWidgetsWithLeakTracking(
      'Material2: Passing no ElevatedButtonTheme returns defaults',
      (WidgetTester tester) async {
    const ColorScheme colorScheme = ColorScheme.light();
    await tester.pumpWidget(
      MaterialApp(
    ...
    Widget buildFrame(
      ...
      return MaterialApp(
        theme: ThemeData.from(
                useMaterial3: false, colorScheme: const ColorScheme.light())
            .copyWith(
  ...
  testWidgetsWithLeakTracking('Material 3: Theme shadowColor',
      (WidgetTester tester) async {
    const ColorScheme colorScheme = ColorScheme.light();
  ...
  testWidgetsWithLeakTracking('Material 2: Theme shadowColor',
      (WidgetTester tester) async {
    const ColorScheme colorScheme = ColorScheme.light();
    const Color shadowColor = Color(0xff000001);
    const Color overriddenColor = Color(0xff000002);
