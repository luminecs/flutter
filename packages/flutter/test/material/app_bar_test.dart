...
void main() {
  ...
  testWidgetsWithLeakTracking('AppBar centers title on iOS',
  ...
  testWidgetsWithLeakTracking('AppBar centerTitle:true centers on Android',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(platform: TargetPlatform.android),
  ...
  testWidgetsWithLeakTracking(
      'AppBar titleSpacing:32 title start edge is 32.0 (RTL)',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Directionality(
  ...
  testWidgetsWithLeakTracking('AppBar centerTitle:false title overflow OK',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('AppBar centerTitle:true title overflow OK (LTR)',
      (WidgetTester tester) async {
    // The app bar's title should be constrained to fit within the available space
  ...
  testWidgetsWithLeakTracking('AppBar centerTitle:true title overflow OK (RTL)',
      (WidgetTester tester) async {
    // The app bar's title should be constrained to fit within the available space
    // between the leading and actions widgets. When it's also centered it may
    // also be start or end justified if it doesn't fit in the overall center.
  ...
  testWidgetsWithLeakTracking('AppBar with no Scaffold',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: SizedBox(
  ...
  testWidgetsWithLeakTracking('AppBar render at zero size',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Center(
  ...
  testWidgetsWithLeakTracking('AppBar actions are vertically centered',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('AppBar drawer icon has default size',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking(
      'Material2 - AppBar drawer icon has default color',
      (WidgetTester tester) async {
    ...
    expect(
        _iconStyle(tester, Icons.menu)?.color, themeData.colorScheme.onPrimary);
  });
  ...
  testWidgetsWithLeakTracking('AppBar drawer icon is sized by iconTheme',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking('AppBar drawer icon is colored by iconTheme',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('AppBar endDrawer icon has default size',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking(
      'Material2 - AppBar endDrawer icon has default color',
      (WidgetTester tester) async {
    final ThemeData themeData = ThemeData.from(
      colorScheme: const ColorScheme.light(),
      useMaterial3: false,
  ...
  testWidgetsWithLeakTracking(
      'Material3 - AppBar endDrawer icon has default color',
      (WidgetTester tester) async {
    final ThemeData themeData = ThemeData.from(
      colorScheme: const ColorScheme.light(),
      useMaterial3: true,
  ...
  testWidgetsWithLeakTracking('AppBar endDrawer icon is sized by iconTheme',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking('AppBar endDrawer icon is colored by iconTheme',
      (WidgetTester tester) async {
    final ThemeData themeData =
        ThemeData.from(colorScheme: const ColorScheme.light());
    const Color color = Color(0xFF2196F3);
  ...
  testWidgetsWithLeakTracking(
      'Material2 - leading widget extends to edge and is square',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Material3 - leading widget extends to edge and is square',
      (WidgetTester tester) async {
    final ThemeData themeData = ThemeData(
      platform: TargetPlatform.android,
      useMaterial3: true,
  ...
  testWidgetsWithLeakTracking(
      'Material2 - Action is 4dp from edge and 48dp min',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Material3 - Action is 4dp from edge and 48dp min',
      (WidgetTester tester) async {
    final ThemeData theme = ThemeData(
      platform: TargetPlatform.android,
      useMaterial3: true,
  ...
  testWidgetsWithLeakTracking('SliverAppBar default configuration',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('SliverAppBar expandedHeight, pinned',
      (WidgetTester tester) async {
    await tester.pumpWidget(buildSliverAppBarApp(
      pinned: true,
  ...
  testWidgetsWithLeakTracking('SliverAppBar expandedHeight, collapsedHeight',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material3 - SliverAppBar.medium defaults',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material3 - SliverAppBar.large defaults',
      (WidgetTester tester) async {
    final ThemeData theme = ThemeData(useMaterial3: true);
    const double collapsedAppBarHeight = 64;
    ...
    final Offset titleOffset = tester.getBottomLeft(expandedTitle);
    expect(titleOffset.dx, 16.0);
    final RenderSliver renderSliverAppBar =
  ...
  testWidgetsWithLeakTracking('scrolledUnderElevation',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Material3 - scrolledUnderElevation with nested scroll view',
      (WidgetTester tester) async {
  ...
  group('SliverAppBar elevation', () {
    ...
    testWidgetsWithLeakTracking('Respects forceElevated parameter',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('Uses elevation of AppBarTheme by default',
        (WidgetTester tester) async {
  ...
  group('SliverAppBar.forceMaterialTransparency', () {
    Material getSliverAppBarMaterial(WidgetTester tester) {
      return tester.widget<Material>(find
          .descendant(
              of: find.byType(SliverAppBar), matching: find.byType(Material))
          .first);
    }
    ...
    (ScrollController, Widget) buildWidget(
      ...
      final ScrollController controller =
          ScrollController(initialScrollOffset: appBarHeight);
  ...
  testWidgetsWithLeakTracking('AppBar in body excludes bottom SafeArea padding',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'AppBar.title sees the correct padding from MediaQuery',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('AppBar updates when you add a drawer',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking(
      'Material2 - AppBar ink splash draw on the correct canvas',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Material3 - AppBar ink splash draw on the correct canvas',
      (WidgetTester tester) async {
    // This is a regression test for https://github.com/flutter/flutter/issues/58665
    final Key key = UniqueKey();
    await tester.pumpWidget(
  ...
  testWidgetsWithLeakTracking('AppBar handles loose children 0',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('AppBar handles loose children 1',
      (WidgetTester tester) async {
    final GlobalKey key = GlobalKey();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgetsWithLeakTracking('AppBar handles loose children 2',
      (WidgetTester tester) async {
    final GlobalKey key = GlobalKey();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgetsWithLeakTracking('AppBar handles loose children 3',
      (WidgetTester tester) async {
    final GlobalKey key = GlobalKey();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgetsWithLeakTracking('SliverAppBar provides correct semantics in LTR',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('SliverAppBar provides correct semantics in RTL',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgetsWithLeakTracking('AppBar excludes header semantics correctly',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgetsWithLeakTracking(
      'SliverAppBar excludes header semantics correctly',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgetsWithLeakTracking(
      'SliverAppBar with flexible space has correct semantics order',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material2 - Default status bar color',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        key: GlobalKey(),
  ...
  testWidgetsWithLeakTracking('Material3 - Default status bar color',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        key: GlobalKey(),
  ...
  testWidgetsWithLeakTracking('Changing SliverAppBar snap from true to false',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('AppBar shape default',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: AppBar(
  ...
  testWidgetsWithLeakTracking('SliverAppBar shape default',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: CustomScrollView(
  ...
  testWidgetsWithLeakTracking('SliverAppBar with shape',
      (WidgetTester tester) async {
    const RoundedRectangleBorder roundedRectangleBorder =
        RoundedRectangleBorder(
      borderRadius: BorderRadius.all(Radius.circular(15.0)),
  ...
  testWidgetsWithLeakTracking('SliverAppBar configures the delegate properly',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('AppBar respects toolbarHeight',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking('SliverAppBar collapsedHeight with toolbarHeight',
      (WidgetTester tester) async {
    const double toolbarHeight = 100.0;
  ...
  testWidgetsWithLeakTracking('SliverAppBar collapsedHeight',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('AppBar respects leadingWidth',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('SliverAppBar respects leadingWidth',
      (WidgetTester tester) async {
    const Key key = Key('leading');
  ...
  testWidgetsWithLeakTracking("AppBar with EndDrawer doesn't have leading",
      (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        appBar: AppBar(),
  ...
  testWidgetsWithLeakTracking('AppBar foregroundColor and backgroundColor',
      (WidgetTester tester) async {
  ...
  group(
      ...
      () {
    testWidgetsWithLeakTracking(
        'Material3 - Icons and IconButtons are colored by IconTheme',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking(
        'Material3 - The actionIconTheme property overrides iconTheme',
        (WidgetTester tester) async {
      final ThemeData themeData = ThemeData.from(
        colorScheme: const ColorScheme.light(),
        useMaterial3: true,
  ...
  group('MaterialStateColor scrolledUnder', () {
    ...
    group('SliverAppBar', () {
      ...
      testWidgetsWithLeakTracking('backgroundColor with FlexibleSpace',
          (WidgetTester tester) async {
        await tester.pumpWidget(
      ...
      testWidgetsWithLeakTracking('backgroundColor - reverse',
          (WidgetTester tester) async {
        await tester
    ...
    group('AppBar', () {
      ...
      testWidgetsWithLeakTracking('backgroundColor for horizontal scrolling',
          (WidgetTester tester) async {
        await tester.pumpWidget(MaterialApp(
          home: Scaffold(
            appBar: AppBar(
      ...
      testWidgetsWithLeakTracking('does not trigger on horizontal scroll',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
  ...
  testWidgetsWithLeakTracking('AppBar.preferredHeightFor',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'AppBar leading widget can take up arbitrary space',
      (WidgetTester tester) async {
    final Key leadingKey = UniqueKey();
    final Key titleKey = UniqueKey();
  ...
  testWidgetsWithLeakTracking('SliverAppBar.medium respects title spacing',
      (WidgetTester tester) async {
    const String title = 'Medium SliverAppBar Very Long Title';
    ...
    Offset iconButtonOffset = tester.getTopRight(find.ancestor(
    ...
    iconButtonOffset =
        tester.getTopLeft(find.widgetWithIcon(IconButton, Icons.sort));
    expect(titleOffset.dx, iconButtonOffset.dx - titleSpacing);
    ...
    iconButtonOffset = tester.getTopRight(find.ancestor(
        of: find.widgetWithIcon(IconButton, Icons.menu),
        matching: find.byType(ConstrainedBox)));
  ...
  testWidgetsWithLeakTracking('SliverAppBar.large respects title spacing',
      (WidgetTester tester) async {
    const String title = 'Large SliverAppBar Very Long Title';
    const double titleSpacing = 16.0;
  ...
  testWidgetsWithLeakTracking('SliverAppBar.medium with bottom widget',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('SliverAppBar.large with bottom widget',
      (WidgetTester tester) async {
    // This is a regression test for https://github.com/flutter/flutter/issues/115091
    const double collapsedAppBarHeight = 64;
    const double expandedAppBarHeight = 152;
  ...
  group('Material 2', () {
    ...
    testWidgetsWithLeakTracking('Material2 - SliverAppBar.medium defaults',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('Material2 - SliverAppBar.large defaults',
        (WidgetTester tester) async {
      final ThemeData theme = ThemeData(useMaterial3: false);
      const double collapsedAppBarHeight = 64;
      const double expandedAppBarHeight = 152;
