...
void main() {
  ...
  testWidgetsWithLeakTracking('Default SliderThemeData debugFillProperties',
  ...
  testWidgetsWithLeakTracking('SliderThemeData implements debugFillProperties',
      (WidgetTester tester) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
  ...
  testWidgetsWithLeakTracking(
      'Slider uses the right theme colors for the right components',
      (WidgetTester tester) async {
    debugDisableShadows = false;
    try {
  ...
  testWidgetsWithLeakTracking('Slider parameters overrides theme properties',
      (WidgetTester tester) async {
    debugDisableShadows = false;
  ...
  testWidgetsWithLeakTracking('Slider uses ThemeData slider theme if present',
      (WidgetTester tester) async {
    final ThemeData theme = ThemeData(
      platform: TargetPlatform.android,
  ...
  testWidgetsWithLeakTracking('SliderThemeData lerps correctly',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Default slider track draws correctly',
      (WidgetTester tester) async {
    final ThemeData theme = ThemeData(
      platform: TargetPlatform.android,
      primarySwatch: Colors.blue,
  ...
  testWidgetsWithLeakTracking('Default slider overlay draws correctly',
      (WidgetTester tester) async {
    final ThemeData theme = ThemeData(
      platform: TargetPlatform.android,
      primarySwatch: Colors.blue,
  ...
  testWidgetsWithLeakTracking(
      'Slider can use theme overlay with material states',
      (WidgetTester tester) async {
    final ThemeData theme = ThemeData(
      platform: TargetPlatform.android,
      primarySwatch: Colors.blue,
  ...
  testWidgetsWithLeakTracking(
      'Default slider ticker and thumb shape draw correctly',
      (WidgetTester tester) async {
    final ThemeData theme = ThemeData(
      platform: TargetPlatform.android,
      primarySwatch: Colors.blue,
  ...
  testWidgetsWithLeakTracking(
    ...
    try {
      ...
      Widget buildApp(String value,
          {double sliderValue = 0.5, double textScale = 1.0}) {
        return MaterialApp(
          theme: theme,
          home: Directionality(
            textDirection: TextDirection.ltr,
      ...
      await tester
          .pumpWidget(buildApp('1000000', sliderValue: 0.0, textScale: 0.5));
      center = tester.getCenter(find.byType(Slider));
      gesture = await tester.startGesture(center);
      // Wait for value indicator animation to finish.
      await tester.pumpAndSettle();
      ...
      await tester
          .pumpWidget(buildApp('1000000', sliderValue: 0.0, textScale: 2.5));
      center = tester.getCenter(find.byType(Slider));
      gesture = await tester.startGesture(center);
      // Wait for value indicator animation to finish.
      await tester.pumpAndSettle();
  ...
  testWidgetsWithLeakTracking('The slider track height can be overridden',
      (WidgetTester tester) async {
    final SliderThemeData sliderTheme =
  ...
  testWidgetsWithLeakTracking(
      'The default slider thumb shape sizes can be overridden',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'The default slider tick mark shape size can be overridden',
      (WidgetTester tester) async {
    final SliderThemeData sliderTheme = ThemeData().sliderTheme.copyWith(
  ...
  testWidgetsWithLeakTracking(
      'The default slider overlay shape size can be overridden',
      (WidgetTester tester) async {
  ...
  // [ShowValueIndicator].
  testWidgetsWithLeakTracking(
      'The slider can skip all of its component painting',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'The slider can skip all component painting except the track',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'The slider can skip all component painting except the thumb',
      (WidgetTester tester) async {
    debugDisableShadows = false;
    try {
  ...
  testWidgetsWithLeakTracking(
      'The slider can skip all component painting except the overlay',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Default range indicator shape skips all painting at zero scale',
      (WidgetTester tester) async {
    debugDisableShadows = false;
    try {
      // Pump a slider with just a value indicator.
  ...
  testWidgetsWithLeakTracking('The mouse cursor is themeable',
      (WidgetTester tester) async {
    await tester.pumpWidget(_buildApp(ThemeData().sliderTheme.copyWith(
  ...
  testWidgetsWithLeakTracking('SliderTheme.allowedInteraction is themeable',
      (WidgetTester tester) async {
    double value = 0.0;
  ...
  testWidgetsWithLeakTracking('Default value indicator color',
      (WidgetTester tester) async {
    debugDisableShadows = false;
    try {
      final ThemeData theme = ThemeData(
