...
void main() {
  ...
  test('test_friction_through', () {
    ...
    FrictionSimulation f =
        FrictionSimulation(0.025, startPosition, startVelocity);
  ...
  test('BoundedFrictionSimulation control test', () {
    final BoundedFrictionSimulation friction =
        BoundedFrictionSimulation(0.3, 100.0, 400.0, 50.0, 150.0);
  ...
  test('test_gravity', () {
    final GravitySimulation gravity =
        GravitySimulation(200.0, 100.0, 600.0, 0.0);
  ...
  test('over/under scroll spring', () {
    final SpringDescription spring = SpringDescription.withDampingRatio(
        mass: 1.0, stiffness: 170.0, ratio: 1.1);
    final BouncingScrollSimulation scroll = BouncingScrollSimulation(
      position: 500.0,
      velocity: -7500.0,
      leadingExtent: 0.0,
