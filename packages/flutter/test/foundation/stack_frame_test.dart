...
void main() {
  ...
  test('Traces from package:stack_trace throw assertion', () {
    try {
      ...
      assert(false,
          'StackFrame.fromStackString did not throw on a mangled stack trace');
    } catch (e) {
...
const List<StackFrame> asyncStackFrames = <StackFrame>[
  StackFrame(
      ...
      package: '<unknown>',
      packagePath:
          '/path/to/flutter/packages/flutter/test/foundation/error_reporting_test.dart',
      line: 40,
      column: 57,
      source:
          '#0      getSampleStack.<anonymous closure> (file:///path/to/flutter/packages/flutter/test/foundation/error_reporting_test.dart:40:57)'),
  ...
  StackFrame(
      ...
      package: '<unknown>',
      packagePath:
          '/path/to/flutter/packages/flutter/foundation/error_reporting_test.dart',
      line: 46,
      column: 40,
      source:
          '#3      main (file:///path/to/flutter/packages/flutter/test/foundation/error_reporting_test.dart:46:40)'),
...
const List<StackFrame> webStackTraceFrames = <StackFrame>[
  StackFrame(
      ...
      package: 'dart-sdk',
      packagePath:
          'lib/_internal/js_dev_runtime/private/ddc_runtime/errors.dart',
      line: 196,
      column: 49,
      source:
          'package:dart-sdk/lib/_internal/js_dev_runtime/private/ddc_runtime/errors.dart 196:49  throw_'),
