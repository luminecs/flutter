...
void main() {
  ...
  testWidgetsWithLeakTracking('SystemChrome overlay style test',
  ...
  test('setApplicationSwitcherDescription control test', () async {
    ...
    await SystemChrome.setApplicationSwitcherDescription(
      const ApplicationSwitcherDescription(
          label: 'Example label', primaryColor: 0xFF00FF00),
    );
  ...
  test('setEnabledSystemUIMode asserts for overlays in manual configuration',
      () async {
    expect(
      () async {
