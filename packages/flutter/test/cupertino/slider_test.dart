...
void main() {
  ...
  testWidgetsWithLeakTracking('Slider does not move when tapped (LTR)',
  ...
  testWidgetsWithLeakTracking('Slider does not move when tapped (RTL)',
      (WidgetTester tester) async {
    final Key sliderKey = UniqueKey();
    double value = 0.0;
  ...
  testWidgetsWithLeakTracking('Slider moves when dragged (LTR)',
      (WidgetTester tester) async {
    final Key sliderKey = UniqueKey();
    double value = 0.0;
  ...
  testWidgetsWithLeakTracking('Slider moves when dragged (RTL)',
      (WidgetTester tester) async {
    final Key sliderKey = UniqueKey();
    double value = 0.0;
    late double startValue;
  ...
  testWidgetsWithLeakTracking('Slider Semantics can be updated',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Slider respects themes',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
        home: Center(
  ...
  testWidgetsWithLeakTracking('Themes can be overridden',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
        theme: const CupertinoThemeData(brightness: Brightness.dark),
  ...
  testWidgetsWithLeakTracking('Themes can be overridden by dynamic colors',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('track color is dynamic',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
  ...
  testWidgetsWithLeakTracking('Thumb color can be overridden',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
        home: Center(
