...
void main() {
  ...
  testWidgetsWithLeakTracking('Action sheet destructive text style',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      boilerplate(
    ...
    final DefaultTextStyle widget =
        tester.widget(find.widgetWithText(DefaultTextStyle, 'Ok'));
  ...
  testWidgetsWithLeakTracking('Action sheet dark mode',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Action sheet default text style',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      boilerplate(
        CupertinoActionSheetAction(
  ...
  testWidgetsWithLeakTracking(
    ...
    final DefaultTextStyle titleStyle = tester
        .firstWidget(find.widgetWithText(DefaultTextStyle, 'Action Sheet'));
    final DefaultTextStyle messageStyle = tester
        .firstWidget(find.widgetWithText(DefaultTextStyle, 'An action sheet'));
  ...
  testWidgetsWithLeakTracking('Content section but no actions',
      (WidgetTester tester) async {
    ...
    expect(
      ...
      tester.getBottomLeft(find.byType(CupertinoActionSheet)) -
          const Offset(-8.0, 10.0),
    );
  ...
  testWidgetsWithLeakTracking('Actions but no content section',
      (WidgetTester tester) async {
    ...
    expect(
      ...
      tester.getTopLeft(find.byType(CupertinoActionSheet)) +
          const Offset(8.0, 10.0),
    );
    ...
    expect(
      ...
      tester.getBottomLeft(
          find.widgetWithText(CupertinoActionSheetAction, 'Two')),
    );
  });

  testWidgetsWithLeakTracking('Action section is scrollable',
      (WidgetTester tester) async {
    final ScrollController actionScrollController = ScrollController();
    addTearDown(actionScrollController.dispose);
    await tester.pumpWidget(
    ...
    expect(
        tester
            .getCenter(find.widgetWithText(CupertinoActionSheetAction, 'One'))
            .dx,
        equals(400.0));
    expect(
        tester
            .getCenter(find.widgetWithText(CupertinoActionSheetAction, 'Two'))
            .dx,
        equals(400.0));
    expect(
        tester
            .getCenter(find.widgetWithText(CupertinoActionSheetAction, 'Three'))
            .dx,
        equals(400.0));
    expect(
        tester
            .getCenter(find.widgetWithText(CupertinoActionSheetAction, 'Four'))
            .dx,
        equals(400.0));
    expect(
        tester
            .getCenter(find.widgetWithText(CupertinoActionSheetAction, 'Five'))
            .dx,
        equals(400.0));
    ...
    expect(
        tester
            .getSize(find.widgetWithText(CupertinoActionSheetAction, 'One'))
            .height,
        equals(92.0));
    expect(
        tester
            .getSize(find.widgetWithText(CupertinoActionSheetAction, 'Two'))
            .height,
        equals(92.0));
    expect(
        tester
            .getSize(find.widgetWithText(CupertinoActionSheetAction, 'Three'))
            .height,
        equals(92.0));
    expect(
        tester
            .getSize(find.widgetWithText(CupertinoActionSheetAction, 'Four'))
            .height,
        equals(92.0));
    expect(
        tester
            .getSize(find.widgetWithText(CupertinoActionSheetAction, 'Five'))
            .height,
        equals(92.0));
  });

  testWidgetsWithLeakTracking('Content section is scrollable',
      (WidgetTester tester) async {
    ...
    expect(
        tester.getSize(find.byType(CupertinoActionSheet)).height, screenHeight);
  });

  testWidgetsWithLeakTracking(
      'CupertinoActionSheet scrollbars controllers should be different',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Tap on button calls onPressed',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('1 action button with cancel button',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(
        CupertinoActionSheet(
  ...
  testWidgetsWithLeakTracking('2 action buttons with cancel button',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(
        CupertinoActionSheet(
  ...
  testWidgetsWithLeakTracking('3 action buttons with cancel button',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(
        CupertinoActionSheet(
  ...
  testWidgetsWithLeakTracking('4+ action buttons with cancel button',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(
        CupertinoActionSheet(
  ...
  testWidgetsWithLeakTracking('1 action button without cancel button',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(
        CupertinoActionSheet(
  ...
  testWidgetsWithLeakTracking('2+ action buttons without cancel button',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(
        CupertinoActionSheet(
  ...
  testWidgetsWithLeakTracking('Action sheet with just cancel button is correct',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(
        CupertinoActionSheet(
  ...
  testWidgetsWithLeakTracking('Cancel button tap calls onPressed',
      (WidgetTester tester) async {
    bool wasPressed = false;
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(
  ...
  testWidgetsWithLeakTracking('Layout is correct when cancel button is present',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(
        CupertinoActionSheet(
    ...
    expect(
      tester
          .getBottomLeft(find.widgetWithText(CupertinoActionSheetAction, 'One'))
          .dy,
  ...
  testWidgetsWithLeakTracking('Enter/exit animation is correct',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(
        CupertinoActionSheet(
    ...
    expect(tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
        moreOrLessEquals(470.0, epsilon: 0.1));

    await tester.pump(const Duration(milliseconds: 60));
    expect(tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
        moreOrLessEquals(374.3, epsilon: 0.1));

    await tester.pump(const Duration(milliseconds: 60));
    expect(tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
        moreOrLessEquals(337.1, epsilon: 0.1));

    await tester.pump(const Duration(milliseconds: 60));
    expect(tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
        moreOrLessEquals(325.3, epsilon: 0.1));

    await tester.pump(const Duration(milliseconds: 60));
    expect(tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
        moreOrLessEquals(320.8, epsilon: 0.1));

    await tester.pump(const Duration(milliseconds: 60));
    expect(tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
        moreOrLessEquals(319.3, epsilon: 0.1));
    ...
    await tester.pump(const Duration(milliseconds: 60));
    expect(tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
        moreOrLessEquals(449.3, epsilon: 0.1));

    await tester.pump(const Duration(milliseconds: 60));
    expect(tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
        moreOrLessEquals(544.9, epsilon: 0.1));

    await tester.pump(const Duration(milliseconds: 60));
    expect(tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
        moreOrLessEquals(582.1, epsilon: 0.1));

    await tester.pump(const Duration(milliseconds: 60));
    expect(tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
        moreOrLessEquals(593.9, epsilon: 0.1));

    await tester.pump(const Duration(milliseconds: 60));
    expect(tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
        moreOrLessEquals(598.5, epsilon: 0.1));
  ...
  testWidgetsWithLeakTracking('Modal barrier is pressed during transition',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(
        CupertinoActionSheet(
  ...
  testWidgetsWithLeakTracking('Action sheet semantics',
      (WidgetTester tester) async {
