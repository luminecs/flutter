...
import '../widgets/editable_text_utils.dart'
    show findRenderEditable, textOffsetToPosition;

class _LongCupertinoLocalizationsDelegate
...
class _LongCupertinoLocalizations extends DefaultCupertinoLocalizations {
  ...
  static Future<_LongCupertinoLocalizations> load(Locale locale) {
    return SynchronousFuture<_LongCupertinoLocalizations>(
        const _LongCupertinoLocalizations());
  }
...
const _LongCupertinoLocalizations _longLocalizations =
...
void main() {
  ...
  group('canSelectAll', () {
    ...
    testWidgets('should return false when there is no text',
        (WidgetTester tester) async {
      final GlobalKey<EditableTextState> key = GlobalKey();
      await tester.pumpWidget(createEditableText(key: key));
      expect(cupertinoTextSelectionControls.canSelectAll(key.currentState!),
          false);
    });
    ...
    testWidgets('should return true when there is text and collapsed selection',
      ...
      expect(
          cupertinoTextSelectionControls.canSelectAll(key.currentState!), true);
    });
  ...
  group('cupertino handles', () {
    testWidgets('draws transparent handle correctly',
        (WidgetTester tester) async {
  ...
  group('Text selection menu overflow (iOS)', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        final TextEditingController controller =
            TextEditingController(text: 'abc def ghi');
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
            find.text(_longLocalizations.selectAllButtonLabel), findsNothing);
        expect(findOverflowBackButton(), findsNothing);
        expect(findOverflowNextButton(), findsNothing);
        ...
        expect(find.text(_longLocalizations.pasteButtonLabel), findsNothing);
        expect(
            find.text(_longLocalizations.selectAllButtonLabel), findsOneWidget);
        expect(findOverflowBackButton(), findsOneWidget);
        expect(findOverflowNextButton(), findsNothing);
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(selectionOffset.dy + 7.0 + 44.0 + 8.0 - 8.0,
            equals(textFieldOffset.dy));
      },
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Iterable<RenderBox> handles =
          tester.renderObjectList(find.descendant(
        of: find.byType(Overlay),
        matching: find.byType(CustomPaint),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(handles.last.size.height,
          50.5); // This is 60.5 with the previous frame.
    },
    skip:
        isBrowser, // [intended] We do not use Flutter-rendered context menu on the Web.
    variant: const TargetPlatformVariant(<TargetPlatform>{TargetPlatform.iOS}),
