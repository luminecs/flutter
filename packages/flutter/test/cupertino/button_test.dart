...
void main() {
  testWidgetsWithLeakTracking('Default layout minimum size',
  ...
  testWidgetsWithLeakTracking('Minimum size parameter',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Size grows with text',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      boilerplate(
          child: const CupertinoButton(
  ...
  */
  ...
  testWidgetsWithLeakTracking('Button child alignment',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
  ...
  testWidgetsWithLeakTracking('Button with background is wider',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking("Disabled button doesn't animate",
      (WidgetTester tester) async {
    await tester.pumpWidget(boilerplate(
        child: const CupertinoButton(
      onPressed: null,
  ...
  testWidgetsWithLeakTracking('Enabled button animates',
      (WidgetTester tester) async {
    await tester.pumpWidget(boilerplate(
        child: CupertinoButton(
      child: const Text('Tap me'),
  ...
  testWidgetsWithLeakTracking('pressedOpacity parameter',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Cupertino button is semantically a button',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Can specify colors',
      (WidgetTester tester) async {
    await tester.pumpWidget(boilerplate(
        child: CupertinoButton(
  ...
  testWidgetsWithLeakTracking('Can specify dynamic colors',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Button respects themes',
      (WidgetTester tester) async {
