...
void main() {
  ...
  testWidgetsWithLeakTracking('Semantics update receives attributed text',
      (WidgetTester tester) async {
    final SemanticsHandle handle = tester.ensureSemantics();
    // Pumps a placeholder to trigger the warm up frame.
    await tester.pumpWidget(
...
class SemanticsUpdateBuilderSpy extends Fake
  ...
  void updateCustomAction(
      ...
      _builder.updateCustomAction(
          id: id, label: label, hint: hint, overrideId: overrideId);
