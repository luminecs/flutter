...
// replacement string.
String _replace(
    String originalText, String replacementText, TextRange replacementRange) {
  assert(replacementRange.isValid);
  return originalText.replaceRange(
      replacementRange.start, replacementRange.end, replacementText);
}
...
abstract class TextEditingDelta with Diagnosticable {
  ...
  factory TextEditingDelta.fromJSON(Map<String, dynamic> encoded) {
    ...
    if (isNonTextUpdate) {
      assert(_debugTextRangeIsValid(newSelection, oldText),
          'The selection range: $newSelection is not within the bounds of text: $oldText of length: ${oldText.length}');
      assert(_debugTextRangeIsValid(newComposing, oldText),
    ...
    assert(_debugTextRangeIsValid(newSelection, newText),
        'The selection range: $newSelection is not within the bounds of text: $newText of length: ${newText.length}');
    assert(_debugTextRangeIsValid(newComposing, newText),
...
class TextEditingDeltaInsertion extends TextEditingDelta {
  ...
  TextEditingValue apply(TextEditingValue value) {
    ...
    newText =
        _replace(newText, textInserted, TextRange.collapsed(insertionOffset));
    assert(_debugTextRangeIsValid(selection, newText),
    ...
    assert(_debugTextRangeIsValid(composing, newText),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
        .add(DiagnosticsProperty<int>('insertionOffset', insertionOffset));
...
class TextEditingDeltaDeletion extends TextEditingDelta {
  ...
  TextEditingValue apply(TextEditingValue value) {
    ...
    // nature of the connection between the framework and platform text input plugins.
    String newText = oldText;
    assert(_debugTextRangeIsValid(deletedRange, newText),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
        .add(DiagnosticsProperty<TextRange>('deletedRange', deletedRange));
    properties.add(DiagnosticsProperty<TextSelection>('selection', selection));
    properties.add(DiagnosticsProperty<TextRange>('composing', composing));
  }
}
...
class TextEditingDeltaReplacement extends TextEditingDelta {
  ...
  TextEditingValue apply(TextEditingValue value) {
    ...
    // nature of the connection between the framework and platform text input plugins.
    String newText = oldText;
    assert(_debugTextRangeIsValid(replacedRange, newText),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
        .add(DiagnosticsProperty<String>('replacementText', replacementText));
    properties
        .add(DiagnosticsProperty<TextRange>('replacedRange', replacedRange));
    properties.add(DiagnosticsProperty<TextSelection>('selection', selection));
    properties.add(DiagnosticsProperty<TextRange>('composing', composing));
  }
}
...
class TextEditingDeltaNonTextUpdate extends TextEditingDelta {
  ...
  TextEditingValue apply(TextEditingValue value) {
    ...
    // policy and apply the delta to the oldText. This is due to the asynchronous
    // nature of the connection between the framework and platform text input plugins.
    assert(_debugTextRangeIsValid(selection, oldText),
    ...
    assert(_debugTextRangeIsValid(composing, oldText),
