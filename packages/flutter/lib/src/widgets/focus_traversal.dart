...
abstract class FocusTraversalPolicy with Diagnosticable {
  ...
  Map<FocusNode?, _FocusTraversalGroupInfo> _findGroups(FocusScopeNode scope,
      _FocusTraversalGroupNode? scopeGroupNode, FocusNode currentNode) {
    ...
    if (forward && focusedChild == sortedNodes.last) {
      switch (nearestScope.traversalEdgeBehavior) {
        ...
        case TraversalEdgeBehavior.closedLoop:
          requestFocusCallback(sortedNodes.first,
    ...
    if (!forward && focusedChild == sortedNodes.first) {
      switch (nearestScope.traversalEdgeBehavior) {
        case TraversalEdgeBehavior.leaveFlutterView:
          ...
          return false;
        case TraversalEdgeBehavior.closedLoop:
          requestFocusCallback(sortedNodes.last,
              alignmentPolicy:
                  ScrollPositionAlignmentPolicy.keepVisibleAtStart);
          return true;
      }
