...
Future<void> main(List<String> arguments) async {
  ...
  final bool treeShakeIcons =
      Platform.environment['TREE_SHAKE_ICONS'] == 'true';
  final bool verbose = Platform.environment['VERBOSE_SCRIPT_LOGGING'] == 'true';
  final bool prefixedErrors =
...
''');
  ...
  final String bundlePlatform =
      targetPlatform.startsWith('windows') ? 'windows' : targetPlatform;
