  ...
  group('containsIgnoreWhitespace Matcher', () {
    group('on item to be contained', () {
      ...
      test("shouldn't match when it's only because of removing whitespaces",
          () {
        expect(
            'Give me anytext!', isNot(containsIgnoringWhitespace('any text!')));
      });

      test('ignores trailing spaces.', () {
        expect(
            'Give me any text!', containsIgnoringWhitespace('any text!    '));
      });
      ...
      test('is case sensitive.', () {
        expect('Give me Any text!',
            isNot(containsIgnoringWhitespace('any text!')));
      });
    });
