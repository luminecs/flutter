...
void main() {
  ...
  testWithoutContext('builds APK analysis correctly', () async {
    ...
    final Archive archive = Archive()
      ...
      ..addFile(ArchiveFile(
          'lib/arm64-v8a/libxyzzyapp.so', 50, List<int>.filled(50, 0)))
      ..addFile(ArchiveFile(
    ...
    final Map<String, dynamic> androidManifestMap =
        resultChildren[0] as Map<String, dynamic>;
    expect(androidManifestMap['n'], 'AndroidManifest.xml');
    expect(androidManifestMap['value'], 6);

    final Map<String, Object?> metaInfMap =
        resultChildren[1] as Map<String, Object?>;
    ...
    final Map<String, Object?> libMap =
        resultChildren[2] as Map<String, Object?>;
    ...
    final List<dynamic> libAppMapChildren =
        libAppMap['children']! as List<dynamic>;
    ...
    final Map<String, Object?> internalMap =
        libAppMapChildren[0] as Map<String, Object?>;
    final List<dynamic> internalMapChildren =
        internalMap['children']! as List<dynamic>;
    final Map<String, Object?> skipMap =
        internalMapChildren[0] as Map<String, Object?>;
    expect(skipMap['n'], 'skip');
    expect(skipMap['value'], 2400);
    final Map<String, Object?> subListIterableMap =
        internalMapChildren[1] as Map<String, Object?>;
    expect(subListIterableMap['n'], 'new SubListIterable.');
    expect(subListIterableMap['value'], 3560);
    final Map<String, Object?> coreMap =
        libAppMapChildren[1] as Map<String, Object?>;
    final List<dynamic> coreMapChildren = coreMap['children']! as List<dynamic>;
    final Map<String, Object?> rangeErrorMap =
        coreMapChildren[0] as Map<String, Object?>;
    expect(rangeErrorMap['n'], 'new RangeError.range');
    expect(rangeErrorMap['value'], 3920);
    final Map<String, Object?> stubsMap =
        libAppMapChildren[2] as Map<String, Object?>;
    final List<dynamic> stubsMapChildren =
        stubsMap['children']! as List<dynamic>;
    final Map<String, Object?> allocateMap =
        stubsMapChildren[0] as Map<String, Object?>;
