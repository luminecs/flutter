...
void main() {
  group('Fingerprinter', () {
    ...
    testWithoutContext(
      ...
      expect(fingerprint,
          Fingerprint.fromBuildInputs(const <String>['a.dart'], fileSystem));
    });
    ...
    group('Fingerprint', () {
      group('fromBuildInputs', () {
        ...
        testWithoutContext('throws if any input file does not exist', () {
          ...
          expect(
            () => Fingerprint.fromBuildInputs(
                const <String>['a.dart', 'b.dart'], fileSystem),
            throwsException,
          );
        });
        ...
        testWithoutContext('populates checksums for valid files', () {
          ...
          final Fingerprint fingerprint = Fingerprint.fromBuildInputs(
              const <String>['a.dart', 'b.dart'], fileSystem);

          final Map<String, dynamic>? jsonObject =
              castStringKeyedMap(json.decode(fingerprint.toJson()));
          final Map<String, dynamic> files =
              jsonObject!['files'] as Map<String, dynamic>;
      ...
      group('fromJson', () {
        ...
        testWithoutContext('creates fingerprint from valid JSON', () {
          ...
          final Map<String, dynamic>? content =
              castStringKeyedMap(json.decode(fingerprint.toJson()));
          final Map<String, dynamic> files =
              content!['files'] as Map<String, dynamic>;
        ...
        testWithoutContext(
          ...
          expect(Fingerprint.fromJson(jsonString),
              Fingerprint.fromBuildInputs(const <String>[], fileSystem));
        });
      });
      ...
      group('operator ==', () {
        testWithoutContext('reports not equal if file checksums do not match',
          ...
          expect(
              Fingerprint.fromJson(json.encode(a)) ==
                  Fingerprint.fromJson(json.encode(b)),
              isFalse);
        });
