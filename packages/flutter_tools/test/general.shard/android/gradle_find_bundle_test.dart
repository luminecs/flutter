...
void main() {
  ...
  testWithoutContext(
    ...
    final FlutterProject project = generateFakeAppBundle(
        'fooBarRelease', 'app-foo-bar-release.aab', fileSystem);
    ...
    expect(bundle.path,
        '/build/app/outputs/bundle/fooBarRelease/app-foo-bar-release.aab');
  });

  testWithoutContext(
      'Finds app bundle when flavor contains underscores in release mode', () {
    final FlutterProject project =
        generateFakeAppBundle('foo_barRelease', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
  ...
  testWithoutContext(
      ...
      () {
    final FlutterProject project =
        generateFakeAppBundle('fooRelease', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
  ...
  testWithoutContext(
      ...
      () {
    final FlutterProject project =
        generateFakeAppBundle('fooaRelease', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
  ...
  testWithoutContext('Finds app bundle when no flavor is used in release mode',
      () {
    final FlutterProject project =
        generateFakeAppBundle('release', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
  ...
  testWithoutContext(
      'Finds app bundle when flavor contains multiple dimensions in debug mode',
      () {
    final FlutterProject project = generateFakeAppBundle(
        'fooBarDebug', 'app-foo-bar-debug.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
    ...
    expect(bundle, isNotNull);
    expect(bundle.path,
        '/build/app/outputs/bundle/fooBarDebug/app-foo-bar-debug.aab');
  });

  testWithoutContext(
      'Finds app bundle when flavor contains underscores in debug mode', () {
    final FlutterProject project =
        generateFakeAppBundle('foo_barDebug', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
  ...
  testWithoutContext(
      ...
      () {
    final FlutterProject project =
        generateFakeAppBundle('fooDebug', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
  ...
  testWithoutContext(
      ...
      () {
    final FlutterProject project =
        generateFakeAppBundle('fooaDebug', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
  ...
  testWithoutContext('Finds app bundle when no flavor is used in debug mode',
      () {
    final FlutterProject project =
        generateFakeAppBundle('debug', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
      BuildInfo.debug,
      BufferLogger.test(),
  ...
  testWithoutContext(
      ...
      () {
    final FlutterProject project = generateFakeAppBundle(
        'fooBarProfile', 'app-foo-bar-profile.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
    ...
    expect(bundle, isNotNull);
    expect(bundle.path,
        '/build/app/outputs/bundle/fooBarProfile/app-foo-bar-profile.aab');
  });

  testWithoutContext(
      'Finds app bundle when flavor contains underscores in profile mode', () {
    final FlutterProject project =
        generateFakeAppBundle('foo_barProfile', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
  ...
  testWithoutContext(
      ...
      () {
    final FlutterProject project =
        generateFakeAppBundle('fooProfile', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
  ...
  testWithoutContext(
      ...
      () {
    final FlutterProject project =
        generateFakeAppBundle('fooaProfile', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
  ...
  testWithoutContext('Finds app bundle when no flavor is used in profile mode',
      () {
    final FlutterProject project =
        generateFakeAppBundle('profile', 'app.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
  ...
  testWithoutContext('Finds app bundle in release mode - Gradle 3.5', () {
    final FlutterProject project =
        generateFakeAppBundle('release', 'app-release.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
      const BuildInfo(BuildMode.release, null, treeShakeIcons: false),
      BufferLogger.test(),
  ...
  testWithoutContext('Finds app bundle in profile mode - Gradle 3.5', () {
    final FlutterProject project =
        generateFakeAppBundle('profile', 'app-profile.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
      const BuildInfo(BuildMode.profile, null, treeShakeIcons: false),
      BufferLogger.test(),
  ...
  testWithoutContext('Finds app bundle in debug mode - Gradle 3.5', () {
    final FlutterProject project =
        generateFakeAppBundle('debug', 'app-debug.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
      BuildInfo.debug,
      BufferLogger.test(),
  ...
  testWithoutContext(
      ...
      () {
    final FlutterProject project = generateFakeAppBundle(
        'foo_barRelease', 'app-foo_bar-release.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
      const BuildInfo(BuildMode.release, 'foo_bar', treeShakeIcons: false),
      BufferLogger.test(),
  ...
  testWithoutContext(
      ...
      () {
    final FlutterProject project = generateFakeAppBundle(
        'foo_barProfile', 'app-foo_bar-profile.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
      const BuildInfo(BuildMode.profile, 'foo_bar', treeShakeIcons: false),
      BufferLogger.test(),
  ...
  testWithoutContext(
      ...
      () {
    final FlutterProject project = generateFakeAppBundle(
        'foo_barDebug', 'app-foo_bar-debug.aab', fileSystem);
    final File bundle = findBundleFile(
      project,
      const BuildInfo(BuildMode.debug, 'foo_Bar', treeShakeIcons: false),
      BufferLogger.test(),
...
FlutterProject generateFakeAppBundle(
    String directoryName, String fileName, FileSystem fileSystem) {
  final FlutterProject project =
      FlutterProject.fromDirectoryTest(fileSystem.currentDirectory);
