...
void main() {
  ...
  testWithoutContext('lexer basic', () {
    ...
    final List<Node> tokens2 = Parser('plural', 'app_en.arb',
    ...
    final List<Node> tokens3 = Parser('gender', 'app_en.arb',
  ...
  testWithoutContext('lexer recursive', () {
    final List<Node> tokens = Parser('plural', 'app_en.arb',
  ...
  testWithoutContext('lexer escaping', () {
    ...
    final List<Node> tokens4 = Parser(
            'escaping', 'app_en.arb', "Flutter''s amazing!",
            useEscaping: true)
        .lexIntoTokens();
    expect(
        tokens4,
  ...
  testWithoutContext('lexer identifier names can be "select" or "plural"', () {
    final List<Node> tokens = Parser('keywords', 'app_en.arb',
  ...
  testWithoutContext('lexer: lexically correct but syntactically incorrect',
      () {
    final List<Node> tokens = Parser('syntax', 'app_en.arb',
...
[app_en.arb:lex] ICU Lexing Error: Unexpected character.
  ...
  testWithoutContext('parser basic', () {
    expect(
        ...
        equals(Node(ST.message, 0, children: <Node>[
    ...
    expect(
        Parser('argumentTest', 'app_en.arb', 'Today is {date, date, ::yMMd}')
            .parse(),
        equals(Node(ST.message, 0, children: <Node>[
  ...
  testWithoutContext('parser escaping', () {
    expect(
        Parser('escaping', 'app_en.arb', "Flutter''s amazing!",
                useEscaping: true)
            .parse(),
        equals(Node(ST.message, 0, children: <Node>[
          Node(ST.string, 0, value: 'Flutter'),
  ...
  testWithoutContext('parser recursive', () {
    expect(
        Parser('pluralGender', 'app_en.arb',
...
[app_en.arb:unexpectedToken] ICU Syntax Error: Expected "identifier" but found ",".
  ...
  testWithoutContext('parser allows select cases with numbers', () {
    final Node node = Parser('numberSelect', 'app_en.arb',
