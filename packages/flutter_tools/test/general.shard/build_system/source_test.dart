...
void main() {
  ...
  test(
      ...
      () => testbed.run(() {
            ...
            expect(
                visitor.sources.single.path, globals.fs.path.absolute('foo'));
          }));
  ...
  test(
      ...
      () => testbed.run(() {
            ...
            expect(
                ...
                globals.fs.path
                    .absolute(globals.fs.path.join('outputs', 'foo')));
          }));
  ...
  test(
      ...
      () => testbed.run(() {
            final String path =
                globals.fs.path.join(environment.buildDir.path, 'bar');
  ...
  test(
      ...
      () => testbed.run(() {
            final String path =
                globals.fs.path.join(environment.flutterRootDir.path, 'foo');
            globals.fs.file(path).createSync();
  ...
  test(
      ...
      () => testbed.run(() {
            ...
            expect(visitor.sources.single.resolveSymbolicLinksSync(),
  ...
  test(
      ...
      () => testbed.run(() {
            ...
            expect(visitor.sources.single.path,
                globals.fs.path.absolute('foo.fizz'));
          }));
  ...
  test(
      ...
      () => testbed.run(() {
            ...
            expect(visitor.sources.single.path,
                globals.fs.path.absolute('fizz.foo'));
          }));
  ...
  test(
      ...
      () => testbed.run(() {
            ...
            expect(
                visitor.sources.single.path, globals.fs.path.absolute('bcbc'));
          }));
  ...
  test(
      ...
      () => testbed.run(() {
            ...
            expect(() => fizzSource.accept(visitor),
  ...
  test(
      ...
      () => testbed.run(() {
            ...
            expect(() => invalidBase.accept(visitor),
                throwsA(isA<InvalidPatternException>()));
          }));
  ...
  test(
      ...
      () => testbed.run(() {
            const Source missingSource =
                Source.pattern('{PROJECT_DIR}/foo', optional: true);
  ...
  test(
      ...
      () => testbed.run(() {
            ...
            final SourceVisitor outputVisitor =
                SourceVisitor(environment, false);
