...
void main() {
  ...
  group('PubDependenciesProjectValidator', () {
    ...
    testWithoutContext('success when all dependencies are hosted', () async {
      ...
      final PubDependenciesProjectValidator validator =
          PubDependenciesProjectValidator(processManager);

      final List<ProjectValidatorResult> result = await validator
          .start(FlutterProject.fromDirectoryTest(fileSystem.currentDirectory));
