...
asset 2 contents
  ...
  List<DeferredComponentModule> get deferredComponents =>
      <DeferredComponentModule>[DeferredComponentModule('component1')];
}

class NoAndroidDynamicFeatureModuleDeferredComponentsConfig
    extends BasicDeferredComponentsConfig {
  @override
  List<DeferredComponentModule> get deferredComponents =>
      <DeferredComponentModule>[];
}
...
class MismatchedGoldenDeferredComponentsConfig
    extends BasicDeferredComponentsConfig {
  @override
  String get deferredComponentsGolden => r'''
  loading-units:
