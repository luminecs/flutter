...
Future<void> buildWindows(
  ...
  final Directory buildDirectory =
      globals.fs.directory(getWindowsBuildDirectory(targetPlatform));
...
Future<void> _runCmakeGeneration({
  ...
  globals.flutterUsage.sendTiming('build', 'windows-cmake-generation',
...
Future<void> _runBuild(
  ...
  globals.flutterUsage.sendTiming('build', 'windows-cmake-build',
      Duration(milliseconds: sw.elapsedMilliseconds));
}
