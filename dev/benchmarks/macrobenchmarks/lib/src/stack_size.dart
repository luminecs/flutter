...
typedef CMmap = ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>,
...
final DartMmap mmap =
    ffi.DynamicLibrary.process().lookupFunction<CMmap, DartMmap>('mmap');

// c interop function:
// int mprotect(void* addr, size_t len, int prot);
typedef CMprotect = ffi.Int32 Function(
    ffi.Pointer<ffi.Void>, ffi.IntPtr, ffi.Int32);
...
final GetStackPointerCallback getStackPointer = () {
  ...
  final io.ProcessResult result =
      io.Process.runSync('getprop', <String>['ro.product.cpu.abi']);
  ...
  final ffi.Pointer<ffi.Void> region = mmap(
      ffi.nullptr,
      kMemorySize,
      kProtRead | kProtWrite,
      kMapPrivate | kMapAnon | kMapJit,
  ...
  region
      .cast<ffi.Uint8>()
      .asTypedList(kMemorySize)
      .setAll(kMemoryStartingIndex, <int>[
  ...
  if (mprotect(region, kMemorySize, kProtRead | kProtExec) !=
      kExitCodeSuccess) {
