...
const String kVeryLongPictureScrollingRouteName =
    '/very_long_picture_scrolling';
...
const String kColorFilterWithUnstableChildName =
    '/color_filter_with_unstable_child';
const String kFadingChildAnimationRouteName = '/fading_child_animation';
const String kImageFilteredTransformAnimationRouteName =
...
const String kAnimatedComplexImageFilteredPerfRouteName =
    '/animated_complex_image_filtered';
...
const String kOpacityPeepholeOneRectRouteName =
    '$kOpacityPeepholeRouteName/one_big_rect';
...
const String kOpacityPeepholeGridOfOpacityRouteName =
    '$kOpacityPeepholeRouteName/grid_of_opacity';
const String kOpacityPeepholeOpacityOfGridRouteName =
    '$kOpacityPeepholeRouteName/opacity_of_grid';
...
const String kGradientPerfRecreateDynamicRouteName =
    '$kGradientPerfRouteName/recreate_dynamic';
...
const String kGradientPerfStaticConsistentRouteName =
    '$kGradientPerfRouteName/static_consistent';
