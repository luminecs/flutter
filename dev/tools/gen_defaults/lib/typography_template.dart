...
''';
  ...
  String _textTheme(String name, String baseline) {
    final StringBuffer theme =
        StringBuffer('static const TextTheme $name = TextTheme(\n');
    theme.writeln(
  ...
  String _textStyleDef(String tokenPrefix, String debugLabel, String baseline) {
    final StringBuffer style =
        StringBuffer("TextStyle(debugLabel: '$debugLabel'");
  ...
  String _fontHeight(String textStyleTokenName) {
    ...
    final double lineHeight =
        getToken('$textStyleTokenName.line-height') as double;
