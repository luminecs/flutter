...
Future<void> main(List<String> rawArguments) async {
  ...
  await generate(
      ...
      path.join(
          ...
          'platform',
          path.join(
              'android', 'test', 'io', 'flutter', 'util', 'KeyCodes.java')),
  ...
  await Future.wait(
    ...
    return generate(
        '$platform map', codeGenerator.outputPath(platform), codeGenerator);
  }));
}
