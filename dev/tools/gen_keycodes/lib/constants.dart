...
class MaskConstant {
  const MaskConstant(
      {required this.name, required this.value, required this.description});
  ...
  const MaskConstant.platform({required String platform, required int value})
      : this(
            ...
            value: value,
            description:
                'The plane value for the private keys defined by the $platform embedding.');
  ...
  String get upperCamelName {
    return name
        .split(' ')
        .map<String>(
            (String word) => lowerCamelToUpperCamel(word.toLowerCase()))
        .join();
  }
