...
class LabeledCheckbox extends StatelessWidget {
  const LabeledCheckbox(
      {super.key, required this.label, this.onChanged, this.value});
      ...
      _ControlTile(
        ...
        child: TextButton(
          style: TextButton.styleFrom(
              foregroundColor: Colors.white, backgroundColor: m2Swatch[200]),
          onPressed: _model.enable ? () {} : null,
          child: label,
        ),
      ),
                ...
                child: Builder(builder: (BuildContext context) {
                  ...
                  return MediaQuery(
                    data: mediaQueryData.copyWith(
                        textScaler: TextScaler.linear(_model.size)),
