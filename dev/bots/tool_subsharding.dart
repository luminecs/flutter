...
class TestFileReporterResults {
  ...
  static void addTestSpec(
      Map<String, Object?> suite, int time, Map<int, TestSpecs> allTestSpecs) {
  ...
  static void addMetricDone(
      int suiteID, int time, Map<int, TestSpecs> allTestSpecs) {
    final TestSpecs testSpec = allTestSpecs[suiteID]!;
    testSpec.endTime = time;
  }

  static bool isMetricDone(
      Map<String, Object?> entry, Map<int, TestSpecs> allTestSpecs) {
