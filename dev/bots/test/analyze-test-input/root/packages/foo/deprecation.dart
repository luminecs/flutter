@Deprecated('This is the reason and what you should use instead. '
...
@Deprecated('bad grammar. '
    'This feature was deprecated after v1.2.3.')
void test3() {}

@Deprecated('Also bad grammar '
    'This feature was deprecated after v1.2.3.')
void test4() {}
...
@Deprecated('This feature was deprecated after v1.2.3.')
void test8() {}

@Deprecated('Not the right syntax. '
    'This feature was deprecated after v1.2.3.')
void test9() {}
...
@Deprecated('URLs are not required. '
    'This feature was deprecated after v1.0.0.')
void test11() {}

@Deprecated('Version number test (should fail). '
...
@Deprecated('Version number test (special beta should pass). '
    'This feature was deprecated after v3.1.0.')
void test15() {}

@Deprecated('Version number test (should be fine). '
...
@Deprecated("Double quotes' test (should fail). "
