...
class UploadResultsCommand extends Command<void> {
  UploadResultsCommand() {
    argParser.addOption('results-file',
        help: 'Test results JSON to upload to Cocoon.');
    argParser.addOption(
      'service-account-token-file',
      help: 'Authentication token for uploading results.',
    );
    argParser.addOption('test-flaky',
    ...
    argParser.addOption('task-name',
        help: '[Flutter infrastructure] Name of the task being run on.');
    argParser.addOption('benchmark-tags',
        help:
    ...
    argParser.addOption('builder-bucket',
        help:
  ...
  String get description =>
      '[Flutter infrastructure] Upload results data to Cocoon/Skia Perf';

  @override
  Future<void> run() async {
    final String? resultsPath = argResults!['results-file'] as String?;
    final String? serviceAccountTokenFile =
        argResults!['service-account-token-file'] as String?;
    ...
    final Cocoon cocoon =
        Cocoon(serviceAccountTokenPath: serviceAccountTokenFile);
