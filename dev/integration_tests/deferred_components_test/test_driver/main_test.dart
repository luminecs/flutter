...
Future<void> main() async {
  ...
  test('Install and load deferred component', () async {
    final String preloadText =
        await driver.getText(find.byValueKey('PreloadText'));
