...
void main() {
  ...
  test('Timeline', () async {
    ...
    await runFrame(() {
      TestRoot.state.updateWidget(
          Placeholder(key: UniqueKey(), color: const Color(0xFFFFFFFF)));
    });
    ...
    args = (events
            .where(
                (TimelineEvent event) => event.json!['name'] == '$Placeholder')
            .single
            .json!['args'] as Map<String, Object?>)
        .cast<String, String>();
